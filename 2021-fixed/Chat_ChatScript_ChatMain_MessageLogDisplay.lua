...
v9.PositionMessageLabelInWindow = function(v44, v45, v46) --[[ Line: 162 ]] --[[ Name: PositionMessageLabelInWindow ]]
    ...
    if v44.MessageObjectLog[v46 - 1] then
        v49 = __2021_if(function() return v46 == #v44.MessageObjectLog end, function() return v44.MessageObjectLog[v46 - 1].BaseFrame.LayoutOrder + 1 end, function() return v44.MessageObjectLog[v46 - 1].BaseFrame.LayoutOrder end);
    end;
