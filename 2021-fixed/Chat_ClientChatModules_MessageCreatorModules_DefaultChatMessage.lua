...
CreateMessageLabel = function(v4, v5) --[[ Line: 10 ]] --[[ Name: CreateMessageLabel ]]
    ...
    local v7 = nil;
    v7 = __2021_if(function() return l_ChatSettings_0.PlayerDisplayNamesEnabled and v4.SpeakerDisplayName end, function() return v4.SpeakerDisplayName end, function() return l_FromSpeaker_0 end);
    local _ = v4.Message;
