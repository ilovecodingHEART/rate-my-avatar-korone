...
CreateSystemMessageLabel = function(v5, v6) --[[ Line: 12 ]] --[[ Name: CreateSystemMessageLabel ]]
    ...
    if v6 ~= v5.OriginalChannel then
        ...
        v14.Text = string.rep(" ", v19) .. l_Message_0;
    end;
    local function v21(v20) --[[ Line: 43 ]] --[[ Name: GetHeightFunction ]]
