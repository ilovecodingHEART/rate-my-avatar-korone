...
CreateMessageLabel = function(v7, v8) --[[ Line: 20 ]] --[[ Name: CreateMessageLabel ]]
    ...
    local v18 = nil;
    v18 = __2021_if(function() return l_ChatSettings_0.PlayerDisplayNamesEnabled and v7.SpeakerDisplayName end, function() return string.format("[%s]:", l_SpeakerDisplayName_0) end, function() return string.format("[%s]:", l_FromSpeaker_0) end);
