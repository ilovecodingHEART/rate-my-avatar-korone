...
v10.setState = function(v21, v22) --[[ Line: 94 ]] --[[ Name: setState ]]
    ...
    if l_lifecyclePhase_0 == v1.ShouldUpdate or l_lifecyclePhase_0 == v1.WillUpdate or l_lifecyclePhase_0 == v1.Render then
        local v25 = v4[v23.lifecyclePhase]:format((tostring(v23.componentClass)));
        error(v25, 2);
    elseif l_lifecyclePhase_0 == v1.WillUnmount then
        return;
    end;
    ...
    local v28 = nil;
    v28 = __2021_if(function() return l_pendingState_0 ~= nil end, function() return v0(l_pendingState_0, v27) end, function() return v0({}, v21.state, v27) end);
...
v10.__getContext = function(v35, v36) --[[ Line: 201 ]] --[[ Name: __getContext ]]
    -- upvalues: v6 (copy), v5 (copy), v2 (copy), v7 (copy)
    if v6.internalTypeChecks then
...
v10.__addContext = function(v37, v38, v39) --[[ Line: 217 ]] --[[ Name: __addContext ]]
...
v10.__validateProps = function(v42, v43) --[[ Line: 244 ]] --[[ Name: __validateProps ]]
...
v10.__mount = function(v47, v48, v49) --[[ Line: 283 ]] --[[ Name: __mount ]]
...
v10.__unmount = function(v56) --[[ Line: 357 ]] --[[ Name: __unmount ]]
...
v10.__update = function(v62, v63, v64) --[[ Line: 382 ]] --[[ Name: __update ]]
    -- upvalues: v6 (copy), v5 (copy), v2 (copy), v7 (copy), v0 (copy)
    if v6.internalTypeChecks then
    ...
    while true do
        ...
        if v64 ~= nil or l_props_1 ~= v62.props then
            v71 = __2021_if(function() return v72 == nil end, function() return v64 or v62.state end, function() return v0(v72, v64) end);
...
v10.__resolveUpdate = function(v74, v75, v76) --[[ Line: 459 ]] --[[ Name: __resolveUpdate ]]
    -- upvalues: v6 (copy), v5 (copy), v2 (copy), v7 (copy), v1 (copy)
    if v6.internalTypeChecks then
