...
-- mechanical fixes applied: %* -> %s x1, pairs() wrap x0, if-expr -> __2021_if x1, compound-assign x0
            ...
            v12({
                ...
                Text = v3.Computed(function() --[[ Line: 144 ]]
                    ...
                    if v17.BannedTil then
                        v18 = v18 .. (" until %s"):format((v17.BannedTil:FormatLocalTime("LL", l_LocalPlayer_0.LocaleId)));
                    end;
                    return v18;
                end)
            }), 
        ...
        for v45, v46 in pairs(v43) do
            ...
            if v46.data.type == "Ban" then
                v44[v45] = v19({
                    ...
                    When = l_result_0, 
                    BannedTil = __2021_if(function() return v46.data.bannedTil end, function() return DateTime.fromIsoDate(v46.data.bannedTil) end, function() return nil end), 
                    LayoutOrder = v45
                });
