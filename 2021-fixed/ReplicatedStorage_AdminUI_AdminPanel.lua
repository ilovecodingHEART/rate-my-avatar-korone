...
-- mechanical fixes applied: %* -> %s x3, pairs() wrap x0, if-expr -> __2021_if x1, compound-assign x0
		...
		if v31:get() then
			...
			v39 = v3.delay(0):andThenCall(v30.LoadBanStatus, v40.Id):andThen(function(v42) --[[ Line: 194 ]]
				if v42.bannerId then
					...
					v42.newReason = ("%s - banned by %s"):format(v42.reason, l_NameFromUserIdAsync_0);
					return v42;
				else
	...
	local v60 = v8({
		...
		Text = v4.Computed(function() --[[ Line: 257 ]]
			if v32:get() and v32:get().isBanned then
				...
				return (("Banned until %s"):format(v57));
			else
				return "";
			end;
		end), 
					...
					v13({
						...
						OnActivated = function() --[[ Line: 427 ]] --[[ Name: OnActivated ]]
							if v49 == "" then
								...
								v30.BanUser(l_Id_0, __2021_if(function() return v49 == "" end, function() return nil end, function() return v49 end), v77);
								v32:set({
									banReason = v49, 
									--bannedTil = v77, 
									isBanned = true
