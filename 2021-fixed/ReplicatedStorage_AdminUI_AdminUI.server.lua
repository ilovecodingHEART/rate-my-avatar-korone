...
-- mechanical fixes applied: %* -> %s x5, pairs() wrap x0, if-expr -> __2021_if x0, compound-assign x0
        ...
        [v7.Children] = {
            ...
            v6({
                ...
                BanUser = function(v36, v37) --[[ Line: 130 ]] --[[ Name: BanUser ]]
                    ...
                    if v38 then
                        return (("Failed to get user id of %s: %s"):format(v36, v38));
                    else
                        local v40 = v24(function() --[[ Line: 137 ]]
                            v9.Function("Ban"):InvokeServer(v39, v37);
                        end);
                        if v40 then
                            return (("Failed to ban %s: %s"):format(v36, v40));
                        else
                            return (("Banned %s successfully"):format(v36));
                        end;
                    end;
                end
            })
