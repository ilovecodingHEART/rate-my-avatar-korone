...
v12.HandleResult = function(v26, v27, v28) --[[ Line: 112 ]] --[[ Name: HandleResult ]]
    ...
    if not v13 then
        ...
        if not v26 then
            ...
            v32 = __2021_if(function() return v27 == "Right" end, function() return l_CFrame_0.Position - l_CFrame_0.RightVector * v33 end, function() return __2021_if(function() return v27 == "Left" end, function() return l_CFrame_0.Position + l_CFrame_0.RightVector * v33 end, function() return l_CFrame_0.Position + l_CFrame_0.RightVector * v31 end) end);
            print("Not Blocked");
        else
