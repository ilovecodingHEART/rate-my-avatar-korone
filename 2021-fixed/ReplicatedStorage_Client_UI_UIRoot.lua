...
return v6(function(_, v27) --[[ Line: 67 ]] --[[ Name: App ]]
    ...
    return l_createElement_0(l_Group_0, {}, {
        Group = if v29 then l_createElement_0(l_Group_0, {}, { -- << MANUAL FIX: if-expr (could not auto-convert) (2021 cannot compile this) >>
            PenaltyMiniGame = __2021_if(function() return v28 ~= "nothing" end, function() return l_createElement_0(l_PenaltyMiniGame_0) end, function() return nil end)
        }) else nil
    });
end);