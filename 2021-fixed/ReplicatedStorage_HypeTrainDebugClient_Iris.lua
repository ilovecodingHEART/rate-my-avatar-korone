...
v1.Init = function(v3, v4, v5) --[[ Line: 73 ]] --[[ Name: Init ]]
    ...
    if v2._started then
        ...
        for _, v8 in pairs(v2._initFunctions) --[[ 2021 ]] do
            v8();
        end;
...
v1.Shutdown = function() --[[ Line: 122 ]] --[[ Name: Shutdown ]]
    ...
    for _, v11 in pairs(v2._connections) --[[ 2021 ]] do
        v11:Disconnect();
    end;
end;
...
v1.Append = function(v15) --[[ Line: 180 ]] --[[ Name: Append ]]
    ...
    local _ = nil;
    v15.Parent = if v2._config.Parent then v2._config.Parent else v2._widgets[v16.type].ChildAdded(v16, { -- << MANUAL FIX: if-expr (could not auto-convert) (2021 cannot compile this) >>
        type = "userInstance"
    });
end;
...
v1.UpdateGlobalConfig = function(v19) --[[ Line: 265 ]] --[[ Name: UpdateGlobalConfig ]]
    -- upvalues: v2 (copy), v1 (copy)
    for v20, v21 in pairs(v19) --[[ 2021 ]] do
