...
-- mechanical fixes applied: %* -> %s x3, pairs() wrap x1, if-expr -> __2021_if x2, compound-assign x0
...
return function(v1) --[[ Line: 3 ]]
    ...
    v1.ComboArray = function(v144, v145, v146) --[[ Line: 1665 ]]
        -- upvalues: v1 (copy)
        local v147 = nil;
        v147 = __2021_if(function() return v145 == nil end, function() return v1.State(v146[1]) end, function() return v145 end);
        local v148 = v1.Internal._Insert("Combo", v144, v147);
        local l_index_0 = v148.state.index;
        for _, v151 in pairs(v146) --[[ 2021 ]] do
    ...
    v1.ComboEnum = function(v152, v153, v154) --[[ Line: 1714 ]]
        -- upvalues: v1 (copy)
        local v155 = nil;
        v155 = __2021_if(function() return v153 == nil end, function() return v1.State(v154:GetEnumItems()[1]) end, function() return v153 end);
    ...
    v1.SetColumnIndex = function(v173) --[[ Line: 2008 ]]
        ...
        assert(v175, (("The index must be between 1 and %s, inclusive."):format(v174.arguments.NumColumns)));
    ...
    v1.SetHeaderColumnIndex = function(v179) --[[ Line: 2055 ]]
        ...
        assert(v181, (("The index must be between 1 and %s, inclusive."):format(v180.arguments.NumColumns)));
        v180._rowIndex = 0;
    ...
    v1.SetColumnWidth = function(v182, v183) --[[ Line: 2076 ]]
        ...
        assert(v185, (("The index must be between 1 and %s, inclusive."):format(v184.arguments.NumColumns)));
