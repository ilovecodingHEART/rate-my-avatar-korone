...
-- mechanical fixes applied: %* -> %s x11, pairs() wrap x19, if-expr -> __2021_if x1, compound-assign x0, shims: __2021_clear, __2021_clone, __2021_freeze
...
return function(v2) --[[ Line: 5 ]]
    ...
    v3._cycleCoroutine = coroutine.create(function() --[[ Line: 75 ]]
        ...
        while v3._started do
            for _, v5 in pairs(v3._connectedFunctions) --[[ 2021 ]] do
    ...
    v8.set = function(v10, v11, v12) --[[ Line: 146 ]] --[[ Name: set ]]
        ...
        if v11 == v10.value and v12 ~= true then
            ...
            for _, v14 in pairs(v10.ConnectedWidgets) --[[ 2021 ]] do
                if v14.lastCycleTick ~= -1 then
                    v3._widgets[v14.type].UpdateState(v14);
                end;
            end;
            for _, v16 in pairs(v10.ConnectedFunctions) --[[ 2021 ]] do
                v16(v11);
            end;
            return v10.value;
        end;
    ...
    v3._cycle = function(v21) --[[ Line: 211 ]] --[[ Name: _cycle ]]
        ...
        if v2.Disabled then
            ...
            for _, v23 in pairs(v3._lastVDOM) --[[ 2021 ]] do
            ...
            task.spawn(function() --[[ Line: 237 ]]
                -- upvalues: v3 (ref)
                for _, v25 in pairs(v3._postCycleCallbacks) --[[ 2021 ]] do
                    v25();
                end;
            end);
            if v3._globalRefreshRequested then
                ...
                for _, v27 in pairs(v3._lastVDOM) --[[ 2021 ]] do
            ...
            if v3._fullErrorTracebacks then
                for _, v30 in pairs(v3._connectedFunctions) --[[ 2021 ]] do
                    v30();
                end;
            else
    ...
    v3.WidgetConstructor = function(v35, v36) --[[ Line: 338 ]] --[[ Name: WidgetConstructor ]]
        ...
        local v38 = {};
        for _, v40 in pairs(v37.All.Required) --[[ 2021 ]] do
            assert(v36[v40] ~= nil, (("field %s is missing from widget %s, it is required for all widgets"):format(v40, v35)));
            v38[v40] = v36[v40];
        end;
        for _, v42 in pairs(v37.All.Optional) --[[ 2021 ]] do
            if v36[v42] == nil then
                v38[v42] = v3._NoOp;
            else
                v38[v42] = v36[v42];
        ...
        if v36.hasState then
            for _, v44 in pairs(v37.IfState.Required) --[[ 2021 ]] do
                assert(v36[v44] ~= nil, (("field %s is missing from widget %s, it is required for all widgets with state"):format(v44, v35)));
                v38[v44] = v36[v44];
            end;
            for _, v46 in pairs(v37.IfState.Optional) --[[ 2021 ]] do
                if v36[v46] == nil then
                    v38[v46] = v3._NoOp;
                else
                    v38[v46] = v36[v46];
        ...
        if v36.hasChildren then
            for _, v48 in pairs(v37.IfChildren.Required) --[[ 2021 ]] do
                assert(v36[v48] ~= nil, (("field %s is missing from widget %s, it is required for all widgets with children"):format(v48, v35)));
                v38[v48] = v36[v48];
            end;
            for _, v50 in pairs(v37.IfChildren.Optional) --[[ 2021 ]] do
                if v36[v50] == nil then
                    v38[v50] = v3._NoOp;
                else
                    v38[v50] = v36[v50];
        ...
        local v51 = {};
        for v52, v53 in pairs(v38.Args) --[[ 2021 ]] do
            v51[v53] = v52;
        end;
        v38.ArgNames = v51;
        for v54, _ in pairs(v38.Events) --[[ 2021 ]] do
    ...
    v3._Insert = function(v56, v57, v58) --[[ Line: 447 ]] --[[ Name: _Insert ]]
        ...
        if v3._VDOM[v59] then
            ...
            if v57 ~= nil then
                ...
                for v62, v63 in pairs(v57) --[[ 2021 ]] do
                    assert(v62 > 0, (("Widget Arguments must be a positive number, not %s of type %s for %s."):format(v62, typeof(v62), v63)));
            ...
            local v65 = __2021_if(function() return v64 == nil end, function() return v3._GenNewWidget(v56, v61, v58, v59) end, function() return v64 end);
    ...
    v3._GenNewWidget = function(v68, v69, v70, v71) --[[ Line: 548 ]] --[[ Name: _GenNewWidget ]]
        ...
        if v74.hasState then
            if v70 then
                for v77, v78 in pairs(v70) --[[ 2021 ]] do
                ...
                v75.state = v70;
                for _, v80 in pairs(v70) --[[ 2021 ]] do
    ...
    v3._EventCall = function(v94, v95) --[[ Line: 710 ]] --[[ Name: _EventCall ]]
        ...
        assert(v96 ~= nil, (("widget %s has no event of name %s"):format(v94.type, v95)));
    ...
    v3._deepCompare = function(v107, v108) --[[ Line: 858 ]] --[[ Name: _deepCompare ]]
        -- upvalues: v3 (copy)
        for v109, v110 in pairs(v107) --[[ 2021 ]] do
