...
-- mechanical fixes applied: %* -> %s x0, pairs() wrap x0, if-expr -> __2021_if x1, compound-assign x0, shims: __2021_round
...
return function(v1, v2) --[[ Line: 3 ]]
    ...
    v1.WidgetConstructor("Combo", {
        ...
        Generate = function(v56) --[[ Line: 252 ]] --[[ Name: Generate ]]
            ...
            l_TextLabel_1.Text = "";
            local v62 = v57 - __2021_round(v57 * 0.2) * 2;
        ...
        UpdateState = function(v76) --[[ Line: 451 ]] --[[ Name: UpdateState ]]
            ...
            l_PreviewLabel_1.Text = __2021_if(function() return typeof(l_value_0) == "EnumItem" end, function() return l_value_0.Name end, function() return tostring(l_value_0) end);
        end, 
