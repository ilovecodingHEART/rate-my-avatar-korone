...
-- mechanical fixes applied: %* -> %s x14, pairs() wrap x0, if-expr -> __2021_if x0, compound-assign x0, shims: __2021_round
...
return function(v1, v2) --[[ Line: 5 ]]
    ...
    local function v11(v6, v7, v8) --[[ Line: 13 ]] --[[ Name: getValueByIndex ]]
        ...
        if v9 == "number" then
            ...
            error((("Incorrect datatype or value: %s %s %s."):format(v6, typeof(v6), v7)));
            return;
        end;
    end;
    local function v19(v12, v13, v14, v15) --[[ Line: 74 ]] --[[ Name: updateValueByIndex ]]
        if typeof(v12) == "number" then
            ...
            error((("Incorrect datatype or value %s %s %s."):format(v12, typeof(v12), v13)));
            return;
        end;
    end;
    local v20 = {
    ...
    v25 = function(v39, v40, v41) --[[ Line: 248 ]] --[[ Name: generateInputScalar ]]
        ...
        return {
                    ...
                    l_TextBox_0.FocusLost:Connect(function() --[[ Line: 314 ]]
                        ...
                        if v52 ~= nil then
                            ...
                            if v43.arguments.Increment then
                                v52 = __2021_round(v52 / v11(v43.arguments.Increment, v50, v43.arguments)) * v11(v43.arguments.Increment, v50, v43.arguments);
                            end;
            ...
            Update = function(v55) --[[ Line: 362 ]] --[[ Name: Update ]]
                ...
                l_Instance_0.TextLabel.Text = v55.arguments.Text or ("Input %s"):format(v39);
                if v40 == 1 then
        ...
        v37 = function(v101, v102, v103) --[[ Line: 526 ]] --[[ Name: generateDragScalar ]]
            ...
            return {
                        ...
                        l_TextBox_1.FocusLost:Connect(function() --[[ Line: 631 ]]
                            ...
                            if v116 ~= nil then
                                ...
                                if v105.arguments.Increment then
                                    v116 = __2021_round(v116 / v11(v105.arguments.Increment, v113, v105.arguments)) * v11(v105.arguments.Increment, v113, v105.arguments);
                                end;
                ...
                Update = function(v124) --[[ Line: 700 ]] --[[ Name: Update ]]
                    ...
                    v124.Instance.TextLabel.Text = v124.arguments.Text or ("Drag %s"):format(v101);
        ...
        v71 = function(v142, ...) --[[ Line: 801 ]] --[[ Name: generateColorDragScalar ]]
            ...
            return v2.extend(v144, {
                ...
                Update = function(v145) --[[ Line: 812 ]] --[[ Name: Update ]]
                    ...
                    v145.Instance.TextLabel.Text = v145.arguments.Text or ("Drag %s"):format(v142);
    ...
    do
        ...
        local function v159() --[[ Line: 871 ]] --[[ Name: updateActiveSlider ]]
            ...
            elseif l_v75_1 == nil then
                ...
                local v158 = math.clamp(__2021_round((v2.getMouseLocation().X - (l_FirstChild_0.AbsolutePosition.X - v2.GuiOffset.X + l_X_1 / 2)) / (l_FirstChild_0.AbsoluteSize.X - l_X_1) * math.floor((v156 - v155) / v154)) * v154 + v155, v155, v156);
        ...
        v72 = function(v165, v166, v167) --[[ Line: 929 ]] --[[ Name: generateSliderScalar ]]
            ...
            return {
                        ...
                        l_TextBox_2.FocusLost:Connect(function() --[[ Line: 1023 ]]
                            ...
                            if v178 ~= nil then
                                ...
                                if v169.arguments.Increment then
                                    v178 = __2021_round(v178 / v11(v169.arguments.Increment, v174, v169.arguments)) * v11(v169.arguments.Increment, v174, v169.arguments);
                                end;
                ...
                Update = function(v182) --[[ Line: 1094 ]] --[[ Name: Update ]]
                    ...
                    l_Instance_3.TextLabel.Text = v182.arguments.Text or ("Slider %s"):format(v165);
                    ...
                    v1._postCycleCallbacks[v195] = function() --[[ Line: 1149 ]]
                        ...
                        if v1._cycleTick >= v196 then
                            if v182.lastCycleTick ~= -1 then
                                ...
                                v1._widgets[("Slider%s"):format(v165)].UpdateState(v182);
                            end;
