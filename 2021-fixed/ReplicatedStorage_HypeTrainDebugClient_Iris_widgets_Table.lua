...
-- mechanical fixes applied: %* -> %s x12, pairs() wrap x12, if-expr -> __2021_if x2, compound-assign x0, shims: __2021_clear, __2021_round
...
return function(v1, v2) --[[ Line: 32 ]]
    ...
    local function v18(v11, v12) --[[ Line: 42 ]] --[[ Name: CalculateMinColumnWidth ]]
        -- upvalues: v1 (copy)
        local v13 = 0;
        for _, v15 in pairs(v11._cellInstances) --[[ 2021 ]] do
    ...
    table.insert(v1._postCycleCallbacks, function() --[[ Line: 56 ]]
        ...
        for _, v20 in pairs(v3) --[[ 2021 ]] do
            for v21, v22 in pairs(v20._rowCycles) --[[ 2021 ]] do
        ...
        for v25, v26 in pairs(v4) --[[ 2021 ]] do
            local v27 = false;
            for v28, _ in pairs(v26) --[[ 2021 ]] do
                v18(v25, v28);
                v27 = true;
            end;
            if v27 then
    ...
    local function v44() --[[ Line: 98 ]] --[[ Name: UpdateActiveColumn ]]
        ...
        if v5 == false or v6 == nil then
            ...
            local v37 = nil;
            local v38 = nil;
            v37 = v7 == 1 and 0 or math.floor(l_BorderContainer_0:FindFirstChild((("Border_%s"):format(v7 - 1))).AbsolutePosition.X + 3 - l_X_0);
            v38 = __2021_if(function() return v7 >= l_NumColumns_0 - 1 end, function() return l_Instance_0.AbsoluteSize.X end, function() return math.floor(l_BorderContainer_0:FindFirstChild((("Border_%s"):format(v7 + 1))).AbsolutePosition.X + 3 - l_X_0) end);
            ...
            if l_FixedWidth_0 then
                l_widths_0.value[v7] = math.clamp(__2021_round(v8 + v40), v35, l_Instance_0.AbsoluteSize.X - v37);
            else
                local v43 = v42 * v40;
    ...
    local function v64(v55, v56, v57) --[[ Line: 219 ]] --[[ Name: GenerateColumnBorder ]]
        ...
        l_ImageButton_0.Name = ("Border_%s"):format(v56);
        ...
        l_Frame_0.BackgroundColor3 = v1._config[("TableBorder%sColor"):format(v57)];
        l_Frame_0.BackgroundTransparency = v1._config[("TableBorder%sTransparency"):format(v57)];
        ...
        l_Frame_1.BackgroundColor3 = v1._config[("TableBorder%sColor"):format(v57)];
        l_Frame_1.BackgroundTransparency = v1._config[("TableBorder%sTransparency"):format(v57)];
    ...
    local function v70(v65, v66) --[[ Line: 273 ]] --[[ Name: GenerateRow ]]
        ...
        l_Frame_2.Name = ("Row_%s"):format(v66);
    ...
    local function v76(_, v72, v73) --[[ Line: 311 ]] --[[ Name: GenerateRowBorder ]]
        ...
        l_Frame_3.Name = ("Border_%s"):format(v72);
        ...
        l_Frame_4.BackgroundColor3 = v1._config[("TableBorder%sColor"):format(v73)];
        l_Frame_4.BackgroundTransparency = v1._config[("TableBorder%sTransparency"):format(v73)];
    ...
    v1.WidgetConstructor("Table", {
        ...
        Update = function(v92) --[[ Line: 442 ]] --[[ Name: Update ]]
            ...
            for v94, v95 in pairs(v92._rowInstances) --[[ 2021 ]] do
                if v94 == 0 then
            ...
            for _, v97 in pairs(v92._rowBorders) --[[ 2021 ]] do
                v97.Visible = v92.arguments.InnerBorders;
            end;
            for _, v99 in pairs(v92._columnBorders) --[[ 2021 ]] do
                v99.Visible = v92.arguments.InnerBorders or v92.arguments.Resizable;
            end;
            for _, v101 in pairs(v92._columnBorders) --[[ 2021 ]] do
        ...
        UpdateState = function(v106) --[[ Line: 514 ]] --[[ Name: UpdateState ]]
            ...
            if not v106.arguments.Resizable then
                if l_FixedWidth_1 then
                    if l_ProportionalWidth_0 then
                        ...
                        local v116 = 0;
                        for _, v118 in pairs(l__minWidths_0) --[[ 2021 ]] do
                ...
                elseif l_ProportionalWidth_0 then
                    local v120 = 0;
                    for _, v122 in pairs(l__minWidths_0) --[[ 2021 ]] do
                        v120 = v120 + v122;
                    end;
                    local v123 = 1 / v120;
            ...
            for v128 = 1, l_NumColumns_3 do
                ...
                local v130 = UDim.new(l_FixedWidth_1 and 0 or math.clamp(v129, 0, 1), __2021_if(function() return l_FixedWidth_1 end, function() return math.max(v129, 0) end, function() return 0 end));
                v106._widths[v128] = v130;
                v127 = v127 + v130;
                for _, v132 in pairs(v106._cellInstances) --[[ 2021 ]] do
