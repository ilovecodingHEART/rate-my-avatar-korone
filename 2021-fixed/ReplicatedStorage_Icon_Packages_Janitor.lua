...
v5.__index.AddPromise = function(v15, v16) --[[ Line: 126 ]] --[[ Name: AddPromise ]]
    -- upvalues: l_RunService_0 (copy)
    local v17 = __2021_if(function() return l_RunService_0:IsRunning() end, function() return require(game:GetService("ReplicatedStorage").Framework).modules.Promise end, function() return nil end);
    if v17 then
...
v5.__index.AddObject = function(v23, v24) --[[ Line: 156 ]] --[[ Name: AddObject ]]
    ...
    local v26 = __2021_if(function() return l_RunService_0:IsRunning() end, function() return require(game:GetService("ReplicatedStorage").Framework).modules.Promise end, function() return nil end);
