...
-- mechanical fixes applied: %* -> %s x0, pairs() wrap x7, if-expr -> __2021_if x0, compound-assign x0
...
v1.SetRadius = function(v7, v8) --[[ Line: 47 ]] --[[ Name: SetRadius ]]
    ...
    if v8 == #v7.IconGroups then
        ...
        for v17 = #v7.IconGroups, v8 + 1, -1 do
            ...
            for _, v20 in pairs(v18) --[[ 2021 ]] do
                v20:Destroy();
            end;
        end;
        return;
...
v1.SetTools = function(v21, v22) --[[ Line: 97 ]] --[[ Name: SetTools ]]
    ...
    v21:SetRadius(v23);
    local v25 = 1;
    for _, v27 in pairs(v21.IconGroups) --[[ 2021 ]] do
...
v1.UpdateFocusedIcon = function(v30, v31, v32) --[[ Line: 120 ]] --[[ Name: UpdateFocusedIcon ]]
    local v33 = nil;
    local v34 = 0.5;
    for _, v36 in pairs(v30.IconGroups) --[[ 2021 ]] do
        for _, v38 in pairs(v36) --[[ 2021 ]] do
...
v1.Destroy = function(v40) --[[ Line: 149 ]] --[[ Name: Destroy ]]
    ...
    for _, v42 in pairs(v40.IconGroups) --[[ 2021 ]] do
