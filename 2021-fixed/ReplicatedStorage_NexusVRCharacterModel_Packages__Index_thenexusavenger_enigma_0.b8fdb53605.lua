...
return function(v6) --[[ Line: 30 ]]
    ...
    if v8 ~= 1 and v8 ~= 2 then
        local v10 = ("Enigma protocol version %s is unsupported and might not work as expected. Supported versions: 1, 2"):format(v8);
        if not v3[v10] then
            v3[v10] = true;
            warn(v10);
        end;
        ...
        for _ = 1, v9 do
            ...
            for _ = 1, v7:ReadNumber() do
                ...
                elseif v23 == 3 then
                    ...
                    local v27 = ("Unsupported property id %s sent with %s values: %s"):format(v23, v24, (table.concat(v25, "|")));
                    if not v3[v27] then
                        v3[v27] = true;
                        warn(v27);
                    end;
