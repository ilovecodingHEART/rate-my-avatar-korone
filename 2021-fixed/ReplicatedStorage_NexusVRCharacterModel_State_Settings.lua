...
v2.SetDefaults = function(v18, v19) --[[ Line: 96 ]] --[[ Name: SetDefaults ]]
    v18.Defaults = v19;
    v18.SettingsCache = {};
    for _, v21 in pairs(v18.SettingsChangeEvents) --[[ 2021 ]] do
        v21:Fire();
    end;
end;
v2.SetOverrides = function(v22, v23) --[[ Line: 110 ]] --[[ Name: SetOverrides ]]
    v22.Overrides = v23;
    v22.SettingsCache = {};
    for _, v25 in pairs(v22.SettingsChangeEvents) --[[ 2021 ]] do
        v25:Fire();
    end;
end;
...
v2.Destroy = function(v28) --[[ Line: 139 ]] --[[ Name: Destroy ]]
    for _, v30 in pairs(v28.SettingsChangeEvents) --[[ 2021 ]] do
        v30:Destroy();
    end;
