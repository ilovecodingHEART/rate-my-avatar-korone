...
-- mechanical fixes applied: %* -> %s x0, pairs() wrap x0, if-expr -> __2021_if x0, compound-assign x0, shims: __2021_clear, __2021_clone, __2021_freeze
...
v7.GetAll = function(v48) --[[ Line: 540 ]] --[[ Name: GetAll ]]
    local v49 = v48[v5];
    if v49 then
        return (__2021_freeze(__2021_clone(v49)));
    else
        return {};
    end;
end;
