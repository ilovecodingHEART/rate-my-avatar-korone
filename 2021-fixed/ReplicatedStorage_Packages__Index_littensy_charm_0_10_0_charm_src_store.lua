...
-- mechanical fixes applied: %* -> %s x7, pairs() wrap x0, if-expr -> __2021_if x0, compound-assign x0, shims: __2021_clear, __2021_clone
...
local function v25(v22) --[[ Line: 88 ]] --[[ Name: notify ]]
    ...
    if v4 then
        ...
        for v24 in next, __2021_clone(v2[v22]) do
            v19(v24);
        end;
        return;
    end;
