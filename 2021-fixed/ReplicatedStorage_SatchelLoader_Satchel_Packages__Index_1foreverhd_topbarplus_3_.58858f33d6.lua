...
-- mechanical fixes applied: %* -> %s x0, pairs() wrap x0, if-expr -> __2021_if x3, compound-assign x0, shims: __2021_find
...
v5.start = function(v7) --[[ Line: 26 ]] --[[ Name: start ]]
    ...
    v6 = v7;
    v6.highlightKey = __2021_if(function() return v6.highlightKey ~= nil end, function() return v6.highlightKey end, function() return l_DPadUp_0 end);
    ...
    task.delay(1, function() --[[ Line: 35 ]]
        ...
        local function v20() --[[ Line: 50 ]] --[[ Name: updateSelectedObject ]]
            ...
            if v18 then
                ...
                v17 = __2021_if(function() return not l_SelectedObject_1 or v14 or v18.parentIconUID end, function() return nil end, function() return Enum.KeyCode.ButtonB end);
                v12 = v18;
                v6.lastHighlightedIcon = v18;
                v18:setIndicator(v17);
                return;
            else
                v17 = __2021_if(function() return not l_SelectedObject_1 or v13 end, function() return nil end, function() return v6.highlightKey end);
                if not v12 then
...
v5.registerButton = function(v33) --[[ Line: 158 ]] --[[ Name: registerButton ]]
    ...
    local v40 = l_UserInputService_0.InputBegan:Connect(function(v36) --[[ Line: 173 ]]
        ...
        if v36.KeyCode == Enum.KeyCode.ButtonA and v34 then
            ...
            if __2021_find(v38, l_Name_0) and v37 and (l_Name_0 ~= "ButtonSelect" or l_GamepadService_0.GamepadCursorEnabled) then
                l_GuiService_0.SelectedObject = nil;
            end;
            return;
        end;
