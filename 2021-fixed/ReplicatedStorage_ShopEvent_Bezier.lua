...
-- mechanical fixes applied: %* -> %s x0, pairs() wrap x0, if-expr -> __2021_if x0, compound-assign x3, shims: __2021_find
	...
	if arg2 and typeof(arg2) == "Instance" and arg2:IsA("BasePart") or typeof(arg2) == "Vector3" then
		...
		if tbl_upvr.Type == "BasePartPoint" then
			...
			table.insert(arg1._connections[arg2], arg2.AncestryChanged:Connect(function(arg1_4, arg2_2) -- Line 91
				...
				if arg2_2 == nil then
					local table_find_result1 = __2021_find(arg1.Points, tbl_upvr)
...
function module_2_upvr.UpdateLength(arg1) -- Line 225
	...
	for i_4 = 1, LengthIterations do
		...
		var33 = var33 + ((any_CalculateDerivativeAt_result1.Magnitude) * (1 / LengthIterations)); --[[ 2021: was compound assignment ]]
...
function module_2_upvr.CalculatePositionAt(arg1, arg2) -- Line 251
	...
	if 0 < #arg1.Points then
		...
		var44 = Vector3.new()
		for i_5 = 1, len_2 do
			var44 = var44 + (B(len_2 - 1, i_5 - 1, arg2) * any_GetAllPoints_result1_2[i_5]); --[[ 2021: was compound assignment ]]
			local var47
		end
		return var44
	end
...
function module_2_upvr.CalculateDerivativeAt(arg1, arg2) -- Line 357
	...
	if 1 < #arg1.Points then
		...
		var52 = Vector3.new()
		for i_6 = 1, len - 1 do
			var52 = var52 + ((B(len - 2, i_6 - 1, arg2)) * ((len - 1) * (any_GetAllPoints_result1[i_6 + 1] - any_GetAllPoints_result1[i_6]))); --[[ 2021: was compound assignment ]]
			local var55
		end
		return var52
	end
