...
-- mechanical fixes applied: %* -> %s x0, pairs() wrap x1, if-expr -> __2021_if x6, compound-assign x0, shims: __2021_freeze
...
local function v24(v17, v18, v19) --[[ Line: 46 ]] --[[ Name: v24 ]]
    for v20, v21 in pairs(v17._handlers) --[[ 2021 ]] do
...
local function _(v28) --[[ Line: 80 ]] --[[ Name: _ ]]
    ...
    v28._connections.inputBegan = l_UserInputService_0.InputBegan:Connect(function(v30, v31) --[[ Line: 86 ]]
        ...
        if __2021_if(function() return v31 end, function() return v30.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v30.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
...
local function _(v38) --[[ Line: 113 ]] --[[ Name: _ ]]
    ...
    v38._connections.inputEnded = l_UserInputService_0.InputEnded:Connect(function(v40, v41) --[[ Line: 119 ]]
        ...
        if __2021_if(function() return v41 end, function() return v40.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v40.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
        else
...
local function _(v47) --[[ Line: 140 ]] --[[ Name: _ ]]
    ...
    v47._connections.inputChanged = l_UserInputService_0.InputChanged:Connect(function(v49, v50) --[[ Line: 146 ]]
        ...
        if __2021_if(function() return v50 end, function() return v49.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v49.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
        else
...
v5.createInputState = function() --[[ Line: 184 ]]
    ...
    v63._connections.inputBegan = l_UserInputService_0.InputBegan:Connect(function(v65, v66) --[[ Line: 207 ]]
        ...
        if __2021_if(function() return v66 end, function() return v65.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v65.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
    ...
    v63._connections.inputEnded = l_UserInputService_0.InputEnded:Connect(function(v69, v70) --[[ Line: 231 ]]
        ...
        if __2021_if(function() return v70 end, function() return v69.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v69.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
        else
    ...
    v63._connections.inputChanged = l_UserInputService_0.InputChanged:Connect(function(v72, v73) --[[ Line: 249 ]]
        -- upvalues: v24 (ref), v63 (copy)
        if __2021_if(function() return v73 end, function() return v72.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v72.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
        else
