...
-- mechanical fixes applied: %* -> %s x0, pairs() wrap x6, if-expr -> __2021_if x1, compound-assign x0, shims: __2021_freeze
...
local function v43(v34, v35, v36) --[[ Line: 83 ]] --[[ Name: setOwner ]]
	...
	local v38 = __2021_if(function() return v36 end, function() return nil end, function() return l_shared_0.owner end);
...
v18.init = function() --[[ Line: 232 ]] --[[ Name: init ]]
	...
	v8.RemoteEvents.AddJetpacks.OnClientEvent:Connect(function(v74) --[[ Line: 236 ]]
		-- upvalues: v62 (ref)
		for _, v76 in pairs(v74) --[[ 2021 ]] do
			v62(v76);
		end;
	end);
	...
	l_RunService_0.PreSimulation:Connect(function(v82) --[[ Line: 259 ]]
		...
		for _, v84 in pairs(v13) --[[ 2021 ]] do
...
v18.getJetpackIdFromModel = function(v85) --[[ Line: 273 ]] --[[ Name: getJetpackIdFromModel ]]
	-- upvalues: v13 (copy)
	for _, v87 in pairs(v13) --[[ 2021 ]] do
