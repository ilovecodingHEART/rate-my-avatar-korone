...
local function v25(v18, v19, v20) --[[ Line: 57 ]] --[[ Name: getHandler ]]
    for v21, v22 in pairs(v18._handlers) --[[ 2021 ]] do
...
local function _(v29) --[[ Line: 84 ]] --[[ Name: setInputBeganConnection ]]
    ...
    v29._connections.inputBegan = l_UserInputService_0.InputBegan:Connect(function(v31, v32) --[[ Line: 86 ]]
        if __2021_if(function() return v32 end, function() return v31.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v31.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
...
local function _(v39) --[[ Line: 109 ]] --[[ Name: setInputEndedConnection ]]
    ...
    v39._connections.inputEnded = l_UserInputService_0.InputEnded:Connect(function(v41, v42) --[[ Line: 111 ]]
        if __2021_if(function() return v42 end, function() return v41.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v41.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
        else
...
local function _(v48) --[[ Line: 130 ]] --[[ Name: setInputChangedConnection ]]
    ...
    v48._connections.inputChanged = l_UserInputService_0.InputChanged:Connect(function(v50, v51) --[[ Line: 132 ]]
        if __2021_if(function() return v51 end, function() return v50.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v50.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
        else
...
v6.createInputState = function() --[[ Line: 165 ]] --[[ Name: createInputState ]]
    ...
    v62._connections.inputBegan = l_UserInputService_0.InputBegan:Connect(function(v64, v65) --[[ Line: 86 ]]
        if __2021_if(function() return v65 end, function() return v64.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v64.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
    ...
    v62._connections.inputEnded = l_UserInputService_0.InputEnded:Connect(function(v68, v69) --[[ Line: 111 ]]
        if __2021_if(function() return v69 end, function() return v68.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v68.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
        else
    ...
    v62._connections.inputChanged = l_UserInputService_0.InputChanged:Connect(function(v71, v72) --[[ Line: 132 ]]
        if __2021_if(function() return v72 end, function() return v71.UserInputType == Enum.UserInputType.MouseButton1 end, function() return v71.UserInputType == Enum.UserInputType.MouseButton1 end) then
            return;
        else
