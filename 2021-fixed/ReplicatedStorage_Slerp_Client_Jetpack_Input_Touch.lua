...
-- mechanical fixes applied: %* -> %s x0, pairs() wrap x0, if-expr -> __2021_if x2, compound-assign x0, shims: __2021_freeze
...
v5.new = function(v9) --[[ Line: 26 ]] --[[ Name: new ]]
    local v13 = l_UserInputService_0.JumpRequest:Connect(function() --[[ Line: 27 ]]
        ...
        local v11 = __2021_if(function() return not l_Character_1 end, function() return nil end, function() return l_Character_1:FindFirstChild("Humanoid") end);
        if not v11 then
            return;
        else
...
v5.inputBeganCallback = function(v22, v23, v24) --[[ Line: 62 ]] --[[ Name: inputBeganCallback ]]
    ...
    elseif not v22._jetpack then
        ...
        local v26 = __2021_if(function() return not l_Character_2 end, function() return nil end, function() return l_Character_2:FindFirstChild("Humanoid") end);
        if not v26 then
            return;
        else
