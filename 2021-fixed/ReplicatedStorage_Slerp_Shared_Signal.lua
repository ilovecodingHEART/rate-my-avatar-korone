...
local v0 = nil;
local function v3(v1, ...) --[[ Line: 36 ]] --[[ Name: acquireRunnerThreadAndCallEventHandler ]]
    local l_v0_0 = v0;
    v0 = nil;
    v1(...);
    v0 = l_v0_0;
end;
local function v4() --[[ Line: 47 ]] --[[ Name: runEventHandlerInFreeThread ]]
    while true do
        v3(coroutine.yield());
    end;
end;
local v5 = {};
v5.__index = v5;
v5.new = function(v6, v7) --[[ Line: 62 ]] --[[ Name: new ]]
    return (setmetatable({
        _connected = true, 
        _signal = v6, 
        _fn = v7, 
...
v15.Connect = function(v16, v17) --[[ Line: 113 ]] --[[ Name: Connect ]]
...
v15.DisconnectAll = function(v19) --[[ Line: 126 ]] --[[ Name: DisconnectAll ]]
    v19._handlerListHead = false;
end;
v15.Fire = function(v20, ...) --[[ Line: 134 ]] --[[ Name: Fire ]]
...
v15.Wait = function(v22) --[[ Line: 151 ]] --[[ Name: Wait ]]
    local v23 = coroutine.running();
    local v24 = nil;
    v24 = v22:Connect(function(...) --[[ Line: 154 ]]
        v24:Disconnect();
        task.spawn(v23, ...);
    end);
    return coroutine.yield();
end;
v15.Once = function(v25, v26) --[[ Line: 163 ]] --[[ Name: Once ]]
    local v27 = nil;
    v27 = v25:Connect(function(...) --[[ Line: 165 ]]
...
setmetatable(v15, {
    __index = function(_, v29) --[[ Line: 176 ]] --[[ Name: __index ]]
        error(("Attempt to get Signal::%s (not a valid member)"):format((tostring(v29))), 2);
    end, 
    __newindex = function(_, v31, _) --[[ Line: 179 ]] --[[ Name: __newindex ]]
