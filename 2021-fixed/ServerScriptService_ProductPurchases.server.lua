...
function _spawnblimp(arg1)
	...
	_promotionblimpmodel.LeftDisplay.Frame.BoothOwner.Username.Text = ("@%s"):format(arg1._plr.username);
	_promotionblimpmodel.RightDisplay.Frame.BoothOwner.Username.Text = ("@%s"):format(arg1._plr.username);
	_promotionblimpmodel.LeftDisplay.Frame.Message.Text = ("%s"):format(_customization.text);
	_promotionblimpmodel.RightDisplay.Frame.Message.Text = ("%s"):format(_customization.text);
	_promotionblimpmodel.LeftDisplay.Frame.BoothOwner.Avatar.Image = ("rbxthumb://type=AvatarHeadShot&id=%s&w=150&h=150"):format(arg1._plr.id);
	_promotionblimpmodel.RightDisplay.Frame.BoothOwner.Avatar.Image = ("rbxthumb://type=AvatarHeadShot&id=%s&w=150&h=150"):format(arg1._plr.id);
	spawn(function()
