...
v0.SummonLightning = function(v9, v10, v11, v12, v13, v14, v15, v16) --[[ Line: 49 ]] --[[ Name: SummonLightning ]]
    ...
    for v32, v33 in pairs(v18) do
        ...
        v36 = __2021_if(function() return v34 ~= nil end, function() return v34.Position + v34.CFrame.UpVector * (v34:GetAttribute("SpreadDistance") * v16) end, function() return v10 end);
