...
for v18, v19 in pairs(v6) --[[ 2021 ]] do
	local v20 = script.Reward:Clone();
	v20.Name = v19.id;
	v20.Parent = script.Parent.Frame;
	v20.RewardInfo.Objective.RewardCount.Text = ("REWARD %s"):format(v18);
	v20.RewardInfo.Objective.ObjectiveText.Text = ("SCORE %s GOALS"):format(v19.goalsRequirement);
