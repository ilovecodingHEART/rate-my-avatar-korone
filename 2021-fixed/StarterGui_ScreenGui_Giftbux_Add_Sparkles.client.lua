...
-- Decompiled on 2026-02-15 10:00:08
-- Luau version 6, Types version 3
-- Time taken: 0.003295 seconds

local TweenService_upvr = game:GetService("TweenService")
local function _(arg1, arg2, arg3, arg4) -- Line 10, Named "tween"
	--[[ Upvalues[1]:
...
while wait(math.random(90, 150) / 100) do
	if game:GetService("Players").LocalPlayer.PlayerGui:WaitForChild("ScreenGui").GiftbuxEarn.Frame.Ads.WatchAd.Active == true then
		spawn(function() -- Line 17
			...
			clone.Position = UDim2.new(math.random(-20, 150) / 100, 0, math.random(-20, 150) / 100, 0)
