...
v18.GetSubjectCFrame = function(v34) --[[ Line: 236 ]] --[[ Name: GetSubjectCFrame ]]
    ...
    if not v37 then
        ...
        elseif v37:IsA("Model") then
            l_lastSubjectCFrame_0 = __2021_if(function() return v37.PrimaryPart end, function() return v37:GetPrimaryPartCFrame() end, function() return CFrame.new() end);
        end;
...
v18.StepZoom = function(v53) --[[ Line: 368 ]] --[[ Name: StepZoom ]]
    ...
    if math.abs(v55) > 0 then
        local v56 = nil;
        v56 = __2021_if(function() return v55 > 0 end, function() return math.max(l_currentSubjectDistance_0 + v55 * (1 + l_currentSubjectDistance_0 * 0.5), v53.FIRST_PERSON_DISTANCE_THRESHOLD) end, function() return math.max((l_currentSubjectDistance_0 + v55) / (1 - v55 * 0.5), 0.5) end);
...
v18.GetSubjectPosition = function(v57) --[[ Line: 393 ]] --[[ Name: GetSubjectPosition ]]
    ...
    if v60 then
        ...
        elseif v60:IsA("Model") then
            l_lastSubjectPosition_0 = __2021_if(function() return v60.PrimaryPart end, function() return v60:GetPrimaryPartCFrame().p end, function() return v60:GetModelCFrame().p end);
        end;
        v57.lastSubject = v60;
