...
v1.Step = function(v25, v26, v27) --[[ Line: 37 ]] --[[ Name: Step ]]
    ...
    return {
        extrapolate = function(v45) --[[ Line: 52 ]] --[[ Name: extrapolate ]]
            ...
            return (__2021_if(function() return l_Magnitude_1 > 1.0E-5 end, function() return CFrame.fromAxisAngle(v47, l_Magnitude_1) end, function() return l_v2_0 end)) * v42 + v46;
        end, 
        posVelocity = v32, 
        rotVelocity = v33
    };
