...
-- mechanical fixes applied: %* -> %s x0, pairs() wrap x0, if-expr -> __2021_if x2, compound-assign x0, shims: __2021_clear
...
local v152 = l_AtomicBinding_0.new({
    ...
    local v123 = {
        ...
        [Enum.HumanoidStateType.Climbing] = function() --[[ Line: 189 ]]
            ...
            if math.abs((__2021_if(function() return v11 end, function() return v12(v33, l_AssemblyLinearVelocity_0) end, function() return l_AssemblyLinearVelocity_0 end)).Y) > 0.1 then
    ...
    local v134 = {
        [v34.Climbing] = function(_, v125, v126) --[[ Line: 214 ]]
            v125.Playing = (__2021_if(function() return v11 end, function() return v12(v33, v126) end, function() return v126 end)).Magnitude > 0.1;
        end, 
