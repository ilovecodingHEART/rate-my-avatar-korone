...
v18.destroy = function(v83) --[[ Line: 252 ]] --[[ Name: destroy ]]
    ...
    __2021_clear(v83._dtorMap);
    for _, v87 in ipairs(v83._connections) do
        v87:Disconnect();
    end;
    __2021_clear(v83._connections);
    ...
    __2021_clear(v83._rootInstToManifest);
    __2021_clear(v83._rootInstToRootNode);
    debug.profileend();
end;
return v18;