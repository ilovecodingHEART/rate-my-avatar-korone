...
-- mechanical fixes applied: %* -> %s x0, pairs() wrap x2, if-expr -> __2021_if x0, compound-assign x1, shims: __2021_clear
...
local function UpdateTheme(self: Ui)
	...
	notificationMainFrame.Title.TextSize = notificationMainFrame.Title.TextSize + (10); --[[ 2021: was compound assignment ]]
	...
	for _, tab in pairs(self._tabs) --[[ 2021 ]] do
		tab:UpdateTheme()
	end
