...
for _, v45 in l_ScreenGui_0:GetChildren() do
	if v45:IsA("Frame") or v45:IsA("VideoFrame") then -- [2021] menus are Frames here (no CanvasGroup)
			...
			if table.find(v43, v45) then
				...
				if v45.Visible then
					for _, v50 in l_ScreenGui_0:GetChildren() do
						if v50 ~= v45 and v50:IsA("Frame") and not table.find(v43, v50) then -- [2021] no CanvasGroup
							v50.Visible = false;
						end;
					end;
