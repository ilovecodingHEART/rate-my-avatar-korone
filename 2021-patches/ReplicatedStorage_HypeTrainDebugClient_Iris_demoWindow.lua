...
return function(v1) --[[ Line: 3 ]]
    ...
    local v76 = {
        ...
        Image = function() --[[ Line: 71 ]] --[[ Name: Image ]]
            ...
            v1.PopConfig();
            v1.Text({
                (("Click count: %s"):format(v27.value))
            });
            v1.End();
            v1.End();
        end, 
        ...
        Plotting = function() --[[ Line: 570 ]] --[[ Name: Plotting ]]
            ...
            v1.ProgressBar({
                "Progress Bar", 
                (("%s/1753"):format((math.floor(v64:get() * 1753))))
            }, {
                progress = v64
            });
            v1.SeparatorText({
    ...
    local function v103() --[[ Line: 662 ]] --[[ Name: runtimeInfo ]]
        ...
        if v91 then
            ...
            for v93, v94 in pairs(v91.arguments) --[[ 2021 ]] do
                v1.Text({
                    v93 .. " - " .. tostring(v94)
                });
            end;
            ...
            if v91.state then
                ...
                for v95, v96 in pairs(v91.state) --[[ 2021 ]] do
                    v1.Text({
        ...
        elseif v92 then
            ...
            for v97, v98 in pairs(v92.ConnectedWidgets) --[[ 2021 ]] do
                v1.Text({
                    v97 .. " - " .. v98.type
                });
            end;
        ...
        if v1.Tree({
            ...
            v91 = 0;
            v92 = "";
            for _, v100 in pairs(l__lastVDOM_0) --[[ 2021 ]] do
                v91 = v91 + 1;
                v92 = v92 .. "\n" .. v100.ID .. " - " .. v100.type;
            end;
            v1.Text({
        ...
        if v1.Tree({
            ...
            v91 = 0;
            v92 = "";
            for v101, v102 in pairs(l__states_0) --[[ 2021 ]] do
                v91 = v91 + 1;
    ...
    local function v104() --[[ Line: 786 ]] --[[ Name: debugPanel ]]
        ...
        v1.Text({
            (("GuiOffset: %s"):format(v1.Internal._utility.GuiOffset))
        });
        v1.Text({
            (("MouseOffset: %s"):format(v1.Internal._utility.MouseOffset))
        });
        v1.SeparatorText({
            "UserInputService"
        });
        v1.Text({
            (("MousePosition: %s"):format((v1.Internal._utility.UserInputService:GetMouseLocation())))
        });
        v1.Text({
            (("MouseLocation: %s"):format((v1.Internal._utility.getMouseLocation())))
        });
        v1.Text({
            (("Left Control: %s"):format((v1.Internal._utility.UserInputService:IsKeyDown(Enum.KeyCode.LeftControl))))
        });
        v1.Text({
            (("Right Control: %s"):format((v1.Internal._utility.UserInputService:IsKeyDown(Enum.KeyCode.RightControl))))
        });
        v1.End();
        v1.End();
    end;
        ...
        local v130 = {
            ...
            }, 
            {
                ...
                function() --[[ Line: 1015 ]]
                    ...
                    v1.End();
                    local v123 = {
                        ["Code (default)"] = Enum.Font.Code --[[ 2021 ]], 
                        ["Ubuntu (template)"] = Enum.Font.Ubuntu --[[ 2021 ]], 
                        Arial = Enum.Font.Arial --[[ 2021 ]], 
                        Highway = Enum.Font.Highway --[[ 2021 ]], 
                        Roboto = Enum.Font.Roboto --[[ 2021 ]], 
                        ["Roboto Mono"] = --[[ 2021 ]] Enum.Font.RobotoMono, 
                        ["Noto Sans"] = --[[ 2021 ]] Enum.Font.Gotham, 
                        ["Builder Sans"] = --[[ 2021 ]] Enum.Font.GothamSemibold, 
                        ["Builder Mono"] = --[[ 2021 ]] Enum.Font.Code, 
                        Sono = --[[ 2021 ]] Enum.Font.Gotham
                    };
                    v1.Text({
                        (("Current Font: %s Weight: %s Style: %s"):format(v1._config.TextFont.Family, v1._config.TextFont.Weight, v1._config.TextFont.Style))
                    });
                    v1.SeparatorText({
                        "Size"
                    });
                    ...
                    for v128, v129 in pairs(v123) --[[ 2021 ]] do
                        v129 = v129; --[[ 2021: v123 entries are Enum.Font items now ]]
                        v1.SameLine();
                        v1.PushConfig({
                            TextFont = v129
                        });
                        if v1.Selectable({
                            ("%s | \"The quick brown fox jumps over the lazy dog.\""):format(v128), 
                            v129.Family
                        }, {
                            index = v125
                        }).selected() then
    ...
    local function v199() --[[ Line: 1254 ]] --[[ Name: tablesDemo ]]
        ...
        if v156.value == false then
            ...
            for v157 = 1, 4 do
                for v158 = 1, 3 do
                    v1.Text({
                        (("Row: %s, Column: %s"):format(v157, v158))
                    });
                    v1.NextColumn();
                end;
            end;
            ...
            for v159 = 1, 4 do
                for v160 = 1, 3 do
                    v1.Text({
                        (("Row: %s, Column: %s"):format(v159, v160))
                    });
                    v1.NextColumn();
                end;
                v1.NextRow();
    ...
    return function() --[[ Line: 1780 ]]
        ...
        if v2.value == false then
            ...
            if v216.state.isUncollapsed.value and v216.state.isOpened.value then
                ...
                for _, v218 in pairs(v77) --[[ 2021 ]] do
                    debug.profilebegin((("Iris/Demo/Widgets/%s"):format(v218)));
                    v76[v218]();
                    debug.profileend();
                end;
                v1.End();
