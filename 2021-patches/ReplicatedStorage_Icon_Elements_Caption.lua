...
return function(v0) --[[ Line: 1 ]]
    ...
    local function _(v32) --[[ Line: 196 ]] --[[ Name: getCaptionPosition ]]
        ...
        local v33 = (__2021_if(function() return v32 ~= nil end, function() return v32 end, function() return l_AbsoluteSize_1 end)) and 10 or 2;
    ...
    local function v49(v35) --[[ Line: 203 ]] --[[ Name: updatePosition ]]
        ...
        if not l_AbsoluteSize_1 then
            ...
            local v36 = __2021_if(function() return v35 ~= nil end, function() return v35 end, function() return l_AbsoluteSize_1 end);
            local v37 = not v36;
            local v38 = (__2021_if(function() return v37 ~= nil end, function() return v37 end, function() return l_AbsoluteSize_1 end)) and 10 or 2;
            local v39 = UDim2.new(0.5, 0, 1, v38);
            v38 = (__2021_if(function() return v36 ~= nil end, function() return v36 end, function() return l_AbsoluteSize_1 end)) and 10 or 2;
    ...
    local function v66(v59) --[[ Line: 276 ]] --[[ Name: setCaptionEnabled ]]
        ...
        if l_AbsoluteSize_1 == v59 then
            ...
            l_TweenService_0:Create(l_CanvasGroup_0, v62, { [l_CanvasGroup_0:IsA("CanvasGroup") and "GroupTransparency" or "BackgroundTransparency"] = v61 } --[[ 2021 ]]):Play();
            v49();
