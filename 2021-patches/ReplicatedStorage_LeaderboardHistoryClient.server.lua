...
task.spawn(function() --[[ Line: 14 ]]
	...
	for _, v7 in v2.Function("GetLeaderboards"):InvokeServer() do
		...
		if v8[3] == "donated" and tonumber(v8[4]) >= 2024 then
			if v8[2] == "monthly" then
				...
				local v10 = DateTime.fromUniversalTime(__2021_if(function() return v8[5] == "12" end, function() return v8[4] + 1 end, function() return v8[4] end), v8[5] == "12" and 1 or v8[5] + 1);
				local v11 = v9:FormatUniversalTime("MMMM", l_LocalPlayer_0.LocaleId);
				local v12 = {
					ed = v10, 
					text = ("%s %s"):format(v11, v8[4]), 
					dkey = ("ldb_monthly_donated_%s_%s"):format(v8[4], v8[5]), 
					rkey = ("ldb_monthly_raised_%s_%s"):format(v8[4], v8[5])
				};
				table.insert(v5, v12);
			elseif v8[2] == "yearly" then
				...
				local v14 = {
					...
					text = ("Year of %s"):format(v8[4]), 
					dkey = ("ldb_yearly_donated_%s"):format(v8[4]), 
					rkey = ("ldb_yearly_raised_%s"):format(v8[4])
				};
				table.insert(v5, v14);
			end;
		end;
	...
	for v17, v18 in pairs(v5) --[[ 2021 ]] do
...
l_LocalPlayer_0.Chatted:Connect(function(chatMsg) -- [2021] legacy chat command hook (was TextChatService.SendingMessage)
...
local function v45() --[[ Line: 111 ]] --[[ Name: render ]]
	...
	xpcall(function() --[[ Line: 123 ]]
		...
		local v31 = {};
		local v32 = {};
		for _, v34 in pairs(v30.leaderboard) --[[ 2021 ]] do
	...
	if v30.count then
		...
		v40.Robux.Text = ("%s"):format((l_formatCommas_0(v30.count)));
	...
	if v30.rank then
		...
		v41.Info.Avatar.Image = ("rbxthumb://type=AvatarHeadShot&id=%s&w=150&h=150"):format(l_LocalPlayer_0.UserId);
		v41.Info.Username.Text = "@" .. l_LocalPlayer_0.Name;
		v41.Robux.Text = ("\238\128\130%s"):format((l_formatCommas_0(v30.score)));
		v41.Seperator.Visible = true;
		v41.Parent = l_LeaderboardHistory_0.Frame.History;
	end;
	for v42, v43 in pairs(v30.leaderboard) --[[ 2021 ]] do
		...
		v44.Robux.Text = ("\238\128\130%s"):format((l_formatCommas_0(v43.robux)));
...
local function v48() --[[ Line: 197 ]] --[[ Name: queuerender ]]
	...
	print((("Waiting for %s seconds"):format(v47)));
	task.wait(v47);
	v46 = nil;
	v45();
end;
