...
local function v38(v35) --[[ Line: 112 ]] --[[ Name: deinitCar ]]
	...
	local v37 = __2021_if(function() return not v36 end, function() return nil end, function() return v24.cars[v36] end);
	if not v37 then
		return;
	else
		v36 = v37.initialized;
...
v23.doesCarExist = function(v44) --[[ Line: 147 ]] --[[ Name: doesCarExist ]]
	...
	if __2021_if(function() return not v45 end, function() return nil end, function() return v24.cars[v45] end) then
		return true;
	else
		return false;
	end;
...
local function _(v46, v47) --[[ Line: 152 ]] --[[ Name: setCarOwner ]]
	...
	if not __2021_if(function() return not v48 end, function() return nil end, function() return v24.cars[v48] end) then
		return;
...
local function v60(v55) --[[ Line: 179 ]] --[[ Name: unregisterCar ]]
	...
	if not v57 then
		...
		if __2021_if(function() return not v59 end, function() return nil end, function() return v24.cars[v59] end) then
...
local function v69(v61) --[[ Line: 201 ]] --[[ Name: initCar ]]
	...
	v63.FilterType = Enum.RaycastFilterType.Blacklist --[[ 2021 ]];
	...
	if __2021_if(function() return not v68 end, function() return nil end, function() return v24.cars[v68] end) then
...
local function v98() --[[ Line: 258 ]] --[[ Name: initScriptConnections ]]
	...
	l_RunService_0.PreRender:Connect(function() --[[ Line: 259 ]]
		...
		for _, v75 in pairs(v24.cars) --[[ 2021 ]] do
	...
	l_RunService_0.PreSimulation:Connect(function(v76) --[[ Line: 272 ]]
		...
		for _, v78 in pairs(v24.cars) --[[ 2021 ]] do
	...
	l_Players_0.PlayerRemoving:Connect(function(v85) --[[ Line: 292 ]]
		...
		if not v86 then
			...
			for _, v88 in pairs(v86) --[[ 2021 ]] do
				v88:Disconnect();
			end;
			return;
		end;
	...
	l_RemoteEvents_0.RegisterCars.OnClientEvent:Connect(function(v91) --[[ Line: 308 ]]
		-- upvalues: v73 (ref)
		for _, v93 in pairs(v91) --[[ 2021 ]] do
			v73(v93);
		end;
	end);
...
v23.setDriver = function(v99, v100) --[[ Line: 330 ]] --[[ Name: setDriver ]]
	...
	local v102 = __2021_if(function() return not v101 end, function() return nil end, function() return v24.cars[v101] end);
	if not v102 then
		return false;
	else
...
v23.getCarIdFromModel = function(v103) --[[ Line: 379 ]] --[[ Name: getCarIdFromModel ]]
	-- upvalues: v24 (copy)
	for _, v105 in pairs(v24.cars) --[[ 2021 ]] do
