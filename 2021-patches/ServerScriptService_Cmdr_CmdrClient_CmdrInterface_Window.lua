...
local TextChatService = nil -- [2021] no TextChatService (legacy chat); visibility toggles use SetCoreGuiEnabled below
...
function Window:SetVisible(visible)
	...
	if visible then
		pcall(function() game:GetService("StarterGui"):SetCoreGuiEnabled(Enum.CoreGuiType.Chat, false) end) -- [2021] hide legacy chat while Cmdr is open
		...
		pcall(function() game:GetService("StarterGui"):SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true) end) -- [2021] restore legacy chat
