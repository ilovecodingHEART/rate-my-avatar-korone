...
v0.display = function(v27, v28, v29) --[[ Line: 47 ]] --[[ Name: display ]]
    ...
    for v50 in string.gmatch(v28, "%S+") do
        ...
        v61 = nil; --[[ 2021: no Enum.FontStyle (italics dropped) ]]
        v51.Font = Enum.Font.GothamSemibold; --[[ 2021 ]]
        if v29 == "bold" then
            v51.Font = Enum.Font.GothamBold; --[[ 2021 ]]
        end;
        local skip_wait_2021 = false; -- [2021] per-iteration flag replacing "continue"
