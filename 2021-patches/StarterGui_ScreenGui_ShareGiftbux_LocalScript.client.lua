...
-- ============================================================
-- [2021] TextChatService does not exist; route gift alerts to the legacy chat.
...
v30.OnClientEvent("ShareGiftbux"):Connect(function(v643, v644, v6455)
	...
	elseif v643 == "recieved" then
		...
		DisplaySystemMessage2021((("<font color= \"rgb(255, 102, 222)\">you received %s giftbux from @%s!</font>"):format(v6455, v644))); -- [2021] legacy chat
		return ;
