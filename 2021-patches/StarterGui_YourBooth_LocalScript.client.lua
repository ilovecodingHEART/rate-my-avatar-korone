...
game:GetService("RunService").RenderStepped:Connect(function() --[[ Line: 34 ]]
    ...
    elseif (workspace.Camera.CFrame.Position - l_Parent_0.Adornee.Position).Magnitude < 50 then
        v11("FadeOut", function() --[[ Line: 38 ]]
            ...
            local v14 = {
                [l_CanvasGroup_0:IsA("CanvasGroup") and "GroupTransparency" or "BackgroundTransparency"] = 1 -- [2021] no CanvasGroup
            };
        ...
        v11("FadeIn", function() --[[ Line: 46 ]]
            ...
            local v18 = {
                [l_CanvasGroup_1:IsA("CanvasGroup") and "GroupTransparency" or "BackgroundTransparency"] = 0 -- [2021] no CanvasGroup
            };
