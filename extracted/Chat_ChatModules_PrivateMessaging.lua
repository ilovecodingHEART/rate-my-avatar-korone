...
local function _(v13) --[[ Line: 30 ]] --[[ Name: GetWhisperChannelId ]]
    return (if l_ChatConstants_0.WhisperChannelPrefix then l_ChatConstants_0.WhisperChannelPrefix else "To ") .. v13;
end;
return function(v15) --[[ Line: 34 ]] --[[ Name: Run ]]
    ...
    local function v40(v23, v24, v25) --[[ Line: 51 ]] --[[ Name: DoWhisperCommand ]]
        ...
        elseif v32 == v6.CommandErrorCodes.MultipleMatches then
            ...
            if l_v15_Speaker_1 then
                local l_v15_Channel_0 = v15:GetChannel((if l_ChatConstants_0.WhisperChannelPrefix then l_ChatConstants_0.WhisperChannelPrefix else "To ") .. v31);
    ...
    local function v53(v46, v47, v48) --[[ Line: 144 ]] --[[ Name: PrivateMessageReplicationFunction ]]
        ...
        local v52 = (if l_ChatConstants_0.WhisperChannelPrefix then l_ChatConstants_0.WhisperChannelPrefix else "To ") .. v46;
    ...
    v15.SpeakerAdded:connect(function(v59) --[[ Line: 177 ]]
        ...
        local v61 = nil;
        v61 = if l_ChatSettings_0.PlayerDisplayNamesEnabled and l_v15_Speaker_4:GetPlayer() then l_v15_Speaker_4:GetNameForDisplay() .. "(@" .. v59 .. ")" else v59;
        local v62 = (if l_ChatConstants_0.WhisperChannelPrefix then l_ChatConstants_0.WhisperChannelPrefix else "To ") .. v59;
        ...
        v63.ChannelNameColor = if l_ChatSettings_0.WhisperChannelNameColor then l_ChatSettings_0.WhisperChannelNameColor else Color3.fromRGB(102, 14, 102);
    ...
    v15.SpeakerRemoved:connect(function(v64) --[[ Line: 209 ]]
        local v65 = (if l_ChatConstants_0.WhisperChannelPrefix then l_ChatConstants_0.WhisperChannelPrefix else "To ") .. v64;
