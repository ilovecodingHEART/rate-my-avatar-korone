...
if v182 then
    v182.Event:connect(function(v190) --[[ Line: 956 ]]
        if MutePlayer(v190) then
            local v191 = nil;
            v191 = if l_ChatSettings_0.PlayerDisplayNamesEnabled then v190.DisplayName else v190.Name;
...
if v183 then
    v183.Event:connect(function(v192) --[[ Line: 978 ]]
        if MutePlayer(v192) then
            local v193 = nil;
            v193 = if l_ChatSettings_0.PlayerDisplayNamesEnabled then v192.DisplayName else v192.Name;
...
if v184 then
    v184.Event:connect(function(v196) --[[ Line: 1008 ]]
        if UnmutePlayer(v196) then
            local v197 = nil;
            v197 = if l_ChatSettings_0.PlayerDisplayNamesEnabled then v196.DisplayName else v196.Name;
...
if v185 then
    v185.Event:connect(function(v198) --[[ Line: 1030 ]]
        if UnmutePlayer(v198) then
            local v199 = nil;
            v199 = if l_ChatSettings_0.PlayerDisplayNamesEnabled then v198.DisplayName else v198.Name;
