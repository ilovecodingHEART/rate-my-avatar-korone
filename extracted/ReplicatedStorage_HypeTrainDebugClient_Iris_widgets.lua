...
return function(v2) --[[ Line: 5 ]]
    ...
    v1.GuiOffset = if v2._config.IgnoreGuiInset then -v1.GuiService:GetGuiInset() else Vector2.zero;
    v1.MouseOffset = if v2._config.IgnoreGuiInset then Vector2.zero else v1.GuiService:GetGuiInset();
    local v3 = nil;
    ...
    v1.findBestWindowPosForPopup = function(v8, v9, v10, v11) --[[ Line: 59 ]] --[[ Name: findBestWindowPosForPopup ]]
        v8 = if v8.X + v9.X + 20 > v11.X then if v8.Y + v9.Y + 20 > v11.Y then v8 + Vector2.new(0, -(20 + v9.Y)) else v8 + Vector2.new(0, 20) else v8 + Vector2.new(20);
