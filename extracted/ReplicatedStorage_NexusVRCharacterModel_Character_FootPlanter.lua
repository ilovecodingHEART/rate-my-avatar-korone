...
v0.CreateSolver = function(_, v12, v13) --[[ Line: 20 ]] --[[ Name: CreateSolver ]]
    ...
    v14.GetFeetCFrames = function(_) --[[ Line: 236 ]] --[[ Name: GetFeetCFrames ]]
        ...
        l_Y_2 = if v101.magnitude > 0 then v101.unit else Vector3.new(0, 0, -1, 0);
        ...
        local function v129(v116, v117) --[[ Line: 275 ]] --[[ Name: positionFootByCycle ]]
            ...
            if (v126 - v116.FootPosition).magnitude > v100 * l_magnitude_0 * 2 then
                ...
                v126 = if (v127 - v126).magnitude < (v128 - v126).magnitude then v127 else v128;
            end;
        ...
        if v130 then
            ...
            local l_p_1 = (v109 * v50.OffsetModifier + (if v70 > 0 then v17 + v17 * 1 * v70 else v17 + v17 * 0.5 * v70) * l_Y_2 - v50.Side * v131).p;
            local l_p_2 = (v109 * v51.OffsetModifier + (if v70 > 0 then v17 + v17 * 1 * v70 else v17 + v17 * 0.5 * v70) * l_Y_2 - v51.Side * v131).p;
            local v134 = nil;
            local v135 = nil;
            ...
            v137 = l_magnitude_0 / (if v70 > 0 then v17 + v18 + (v17 + v18) * 1.5 * v70 else v17 + v18 + (v17 + v18) * 0.5 * v70) * v136;
            if not l_X_5 and not l_Z_5 then
                if (v51.FootPosition - v51.AheadStep).magnitude < (v50.FootPosition - v50.AheadStep).magnitude then
                    v51.StepSpeedMod = 1 / (1 - l_min_0(0.9, (l_max_0(0, (v51.FootPosition - v51.AheadStep).magnitude / if v70 > 0 then v17 + v18 + (v17 + v18) * 1.5 * v70 else v17 + v18 + (v17 + v18) * 0.5 * v70))));
                    v51.StepCycle = v100;
                    v51.Takeoff = v51.FootPosition;
                else
                    v50.StepSpeedMod = 1 / (1 - l_min_0(0.9, (l_max_0(0, (v50.FootPosition - v50.AheadStep).magnitude / if v70 > 0 then v17 + v18 + (v17 + v18) * 1.5 * v70 else v17 + v18 + (v17 + v18) * 0.5 * v70))));
                    v50.StepCycle = v100;
            ...
            if l_X_5 or l_Z_5 then
                for _, v143 in pairs(v54) do
                    if v143.StepCycle > 0 then
                        ...
                        local v146 = nil;
                        v146 = if v145.magnitude > v20 then l_p_3 + v145.unit * v20 else v143.LastStepTo;
                        local v147 = nil;
            ...
            if v50.StepCycle == 0 and v51.StepCycle == 0 then
                ...
                if v156:Dot(l_X_4) > v16 / 4 then
                    ...
                    v50.StepSpeedMod = 1 / (1 - l_min_0(0.9, (l_max_0(0, (v50.FootPosition - v50.LastStepTo).magnitude / if v70 > 0 then v17 + v18 + (v17 + v18) * 1.5 * v70 else v17 + v18 + (v17 + v18) * 0.5 * v70))));
                elseif v157:Dot(l_X_4) < -v16 / 4 then
                    ...
                    v51.StepSpeedMod = 1 / (1 - l_min_0(0.9, (l_max_0(0, (v51.FootPosition - v51.LastStepTo).magnitude / if v70 > 0 then v17 + v18 + (v17 + v18) * 1.5 * v70 else v17 + v18 + (v17 + v18) * 0.5 * v70))));
