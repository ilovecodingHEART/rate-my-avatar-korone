...
v4.GetNeckCFrame = function(v10, v11, v12) --[[ Line: 50 ]] --[[ Name: GetNeckCFrame ]]
    ...
    if v12 then
        ...
        v15 = if v20 < v19 then v19 - v20 else if v19 < -v20 then v19 + v20 else 0;
    else
        ...
        if l_LastNeckRotationGlobal_0 then
            ...
            if math.abs(v23) < 1.5 * v21 then
                v15 = if v21 < v23 then v15 - v21 else if v23 < -v21 then v15 + v21 else l_LastNeckRotationGlobal_0;
            end;
        end;
    end;
