...
v0.SendQueuedData = function(v12) --[[ Line: 60 ]] --[[ Name: SendQueuedData ]]
    ...
    for v16, v17 in l_QueuedData_0 do
        local v18 = v12.SerializeMessage(v16, v17);
        local v19 = buffer.len(v18);
        if v12.MaxRequestSize < v19 then
            warn((("Data was serialzied for key %* and was too long (%* > %*). The data will be dropped."):format(v16, v19, l_MaxRequestSize_0)));
        else
            local v20 = v14[#v14];
