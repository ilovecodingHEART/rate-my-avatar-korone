...
local function _(v20) --[[ Line: 59 ]] --[[ Name: postInit ]]
	...
	local v22 = if not l_Character_1 then nil else l_Character_1:FindFirstChild("Humanoid");
	local v23;
...
local function v42(v26) --[[ Line: 66 ]] --[[ Name: addCar ]]
	...
	local v39 = if not l_Character_3 then nil else l_Character_3:FindFirstChild("Humanoid");
	local v40;
...
local function v53() --[[ Line: 123 ]] --[[ Name: hideAllProximityPrompts ]]
	-- upvalues: v11 (copy)
	for _, v50 in v11.cars do
		for _, v52 in v50.shared.seats do
...
local function v58() --[[ Line: 131 ]] --[[ Name: showProximityPrompts ]]
	-- upvalues: v11 (copy)
	for _, v55 in v11.cars do
		for _, v57 in v55.shared.seats do
...
local function v66(v59) --[[ Line: 139 ]] --[[ Name: removeCar ]]
	...
	if not v60 then
		...
		for _, v62 in v60.proximityPromptTriggeredConnections do
			v62:Disconnect();
		end;
		...
		if v63 == v59 or not v63 then
			...
			local v65 = if not l_Character_4 then nil else l_Character_4:FindFirstChild("Humanoid");
			if v65 then
			...
			if not v75 and v77.occupant == v74 then
				...
				if v78 then
					...
					if v80.occupant == l_LocalPlayer_0 then
						...
						local v82 = if not l_Character_5 then nil else l_Character_5:FindFirstChild("Humanoid");
						if v82 then
				...
				if v74 == l_LocalPlayer_0 then
					...
					if v11.locallySeated then
						if v72 == v11.locallySeated.carId and v73 == v11.locallySeated.seatIndex then
							...
							local v84 = if not l_Character_6 then nil else l_Character_6:FindFirstChild("Humanoid");
							if v84 then
								v84:UnequipTools();
