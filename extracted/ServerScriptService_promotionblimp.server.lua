...
function _spawnblimp(arg1)
	...
	_promotionblimpmodel.A.Frame.BoothOwner.Username.Text = ("@%*"):format(arg1._plr.username);
	_promotionblimpmodel.B.Frame.BoothOwner.Username.Text = ("@%*"):format(arg1._plr.username);
	_promotionblimpmodel.A.Frame.Message.Text = ("%*"):format(_customization.text);
	_promotionblimpmodel.B.Frame.Message.Text = ("%*"):format(_customization.text);
	_promotionblimpmodel.A.Frame.BoothOwner.Avatar.Image = ("rbxthumb://type=AvatarHeadShot&id=%*&w=150&h=150"):format(arg1._plr.id);
	_promotionblimpmodel.B.Frame.BoothOwner.Avatar.Image = ("rbxthumb://type=AvatarHeadShot&id=%*&w=150&h=150"):format(arg1._plr.id);
	spawn(function()
