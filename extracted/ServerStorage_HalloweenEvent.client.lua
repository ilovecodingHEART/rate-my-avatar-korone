...
local v1 = {
	CenterOfEvent = Vector3.new(166.436, 6.485, 307.589)
};
local v2 = false;
...
l_Part_1.Color = Color3.fromRGB(0, 255, 0);
...
l_PointLight_0.Color = Color3.fromRGB(85, 255, 0);
...
l_Part_3.Color = Color3.fromRGB(60, 147, 82);
l_Part_3.Size = Vector3.new(225, 0, 225, 0);
...
pcall(function() --[[ Line: 189 ]]
	...
	if v2 == true then
        ...
        for v64 = 0, 10 do
            ...
            v65.Position = CFrame.new(v1.CenterOfEvent):ToWorldSpace(CFrame.Angles(0, math.rad(v64 / 11 * 360), 0)).LookVector * 58 + v1.CenterOfEvent + Vector3.new(0, 5, 0, 0);
        ...
        for _, v67 in pairs(v48) do
            ...
            l_Beam_0.Color = ColorSequence.new(Color3.fromRGB(0, 255, 0));
            l_Beam_0.Parent = v67;
        ...
        v49 = l_RunService_0.Heartbeat:Connect(function(v79) --[[ Line: 322 ]]
            ...
            for _, v81 in pairs(v48) do
                v81.Position = CFrame.new(v1.CenterOfEvent):ToWorldSpace(CFrame.Angles(0, math.rad(v81:GetAttribute("Index") / 11 * 360), 0)):ToWorldSpace(CFrame.Angles(0, math.rad(v47), 0)).LookVector * l_NumberValue_1.Value + v1.CenterOfEvent + Vector3.new(0, l_NumberValue_0.Value, 0);
            end;
        end);
        ...
        l_TweenService_0:Create(l_ColorCorrectionEffect_0, TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.In, 0, false, 5), {
            ...
            Contrast = 0, 
            Saturation = 0, 
            TintColor = Color3.fromRGB(200, 255, 200)
        }):Play();
        task.wait(6);
        ...
        spawn(function() --[[ Line: 437 ]]
            ...
            repeat
                ...
                v101.Size = Vector3.new(v102, 200, v102);
                v101.Transparency = 1;
        ...
        spawn(function() --[[ Line: 463 ]]
            ...
            repeat
                ...
                v105.Size = Vector3.new(v106, 0, v106);
                v105.Transparency = 1;
        ...
        spawn(function() --[[ Line: 547 ]]
            -- upvalues: v1 (ref), l_Part_0 (ref), l_Debris_0 (ref), v15 (ref), l_ColorCorrectionEffect_1 (copy), l_TweenService_0 (ref), v13 (ref), v99 (ref)
            repeat
                ...
                l_ColorCorrectionEffect_1.TintColor = Color3.fromRGB(200, 255, 200);
                ...
                v13.SummonLightning(v119 + Vector3.new(math.random(-50, 50), 200, math.random(-50, 50)), Vector3.new(math.random(-100, 100), 0, math.random(-100, 100)) + v1.CenterOfEvent, Color3.fromRGB(0, 255, 0), Vector2.new(0, 5), 3, 10, 1, 1);
            until v99 == false;
        end);
        ...
        l_TweenService_0:Create(l_Sounds_0.ChaoticEnergyLoop, TweenInfo.new(9.5, Enum.EasingStyle.Quart, Enum.EasingDirection.In, 0, false, 0), {
            PlaybackSpeed = 1.5, 
            Volume = 1
        }):Play();
        local l_Quint_1 = Enum.EasingStyle.Quint;
        l_TweenService_0:Create(l_Sounds_0.HeavyWindLoop, TweenInfo.new(10, l_Quint_1, Enum.EasingDirection.In, 0, false, 0), {
            PlaybackSpeed = 1.5, 
            Volume = 1
        }):Play();
        l_TweenService_0:Create(l_ColorCorrectionEffect_0, TweenInfo.new(9.5, Enum.EasingStyle.Quad, Enum.EasingDirection.In, 0, false, 0), {
            Brightness = -0.15, 
            Contrast = 0.25, 
            Saturation = 0.5, 
            TintColor = Color3.fromRGB(50, 255, 50)
        }):Play();
        l_TweenService_0:Create(v52.Vignette, TweenInfo.new(9, Enum.EasingStyle.Sine, Enum.EasingDirection.In, 0, false, 0), {
            ImageTransparency = 0
        }):Play();
        local l_Out_1 = Enum.EasingDirection.Out;
        l_TweenService_0:Create(l_NumberValue_2, TweenInfo.new(9, Enum.EasingStyle.Quint, l_Out_1, 0, false, 0), {
            Value = 300
        }):Play();
        local l_Quad_1 = Enum.EasingStyle.Quad;
        l_TweenService_0:Create(l_NumberValue_1, TweenInfo.new(9, l_Quad_1, Enum.EasingDirection.Out, 0, false, 0), {
            Value = 300
        }):Play();
        local l_Quad_2 = Enum.EasingStyle.Quad;
        l_TweenService_0:Create(l_NumberValue_4, TweenInfo.new(9, l_Quad_2, Enum.EasingDirection.Out, 0, false, 0), {
            Value = 30
        }):Play();
        local v126 = 9;
        local v127 = {
        ...
        l_TweenService_0:Create(v91.LeavesRustle, TweenInfo.new(9, Enum.EasingStyle.Quint, Enum.EasingDirection.InOut, 0, false, 0), {
            PlaybackSpeed = 1.5, 
            Volume = 2
        }):Play();
        local l_InOut_1 = Enum.EasingDirection.InOut;
        l_TweenService_0:Create(l_NumberValue_3, TweenInfo.new(9, Enum.EasingStyle.Quint, l_InOut_1, 0, false, 0), {
            Value = 50
        }):Play();
