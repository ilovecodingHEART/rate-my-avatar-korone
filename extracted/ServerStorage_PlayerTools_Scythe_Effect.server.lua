...
function hoyya(hammer)
	...
	elseif hammer == "hit" then
		...
		EmitPoint.Flames:Emit(30)
		EmitPoint.Impact_RaysBurst:Emit(40)
		EmitPoint.ParticleEmitter:Emit(30)
		EmitPoint.SmoothRaysBig:Emit(17)
		EmitPoint.SparkleExplosion:Emit(13)
		EmitPoint.BrightFlare:Emit(11)
	end
end
