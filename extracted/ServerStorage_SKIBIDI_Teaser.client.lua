...
local function v27() --[[ Line: 7 ]] --[[ Name: Run ]]
    ...
    v12();
    l_Assets_0.Sounds.Skibidi:Play();
    task.wait(1.5);
	l_Assets_0.Sounds.Drop_Sting1:Play();
	delay(5, function()
		l_Assets_0.Sounds.fart:Play();
		while wait(5) do
			l_Assets_0.Sounds.fart:Play();
			wait(0.5)
			l_Assets_0.Sounds.fart:Play();
    ...
    local v23 = l_Services_0.TweenService:Create(v18.Root, TweenInfo.new(40, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {
        CFrame = v22
    });
    v23:Play();
    local _ = l_Services_0.RunService.RenderStepped:Connect(function() --[[ Line: 121 ]]
        ...
        if v18:FindFirstChild("Root") then
            ...
            v18.Root.CFrame = v18.Root.CFrame * CFrame.Angles(0, 20, 0);
        end;
    end);
