...
l_ProximityPrompt_0.Triggered:Connect(function() --[[ Line: 25 ]]
    ...
    if l_LocalPlayer_0:GetAttribute("SelectedClubTeam") then
        ...
        l_Parent_0.Frame.Speech.Text = ("Hey %*! Ready to see where you stand?"):format(l_LocalPlayer_0.DisplayName);
        ...
        l_Parent_0.Frame.Speech.MaxVisibleGraphemes = -1;
        l_Parent_0.Frame.Speech.TextTransparency = 0;
        l_Parent_0.Frame.Speech.Text = ("Hey %*. Looks like you\226\128\153re still without a team. Go to the Stadium Entrance and select the club you want to support!"):format(l_LocalPlayer_0.DisplayName);
        tween(l_Parent_0.Frame.Speech, 2, {
            MaxVisibleGraphemes = #l_Parent_0.Frame.Speech.Text
        });
        task.wait(5);
