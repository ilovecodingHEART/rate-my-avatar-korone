...
rewind = function() --[[ Line: 49 ]] --[[ Name: rewind ]]
    ...
    v6.display(-1, ("You donated \238\128\130%* Robux this year. That's more than %*%% of all donors (#%* of #%*). Making waves in the community."):format(v19.thisyeardonated, v22, v19.rank + 1, v19.count), "none");
    local v23 = nil;
    for _, v25 in v19.donations do
        if v25.donatorUserId == userid and (v23 == nil or v25.donatedRobux > v23.donatedRobux) then
            v23 = v25;
        end;
    end;
    if v23 then
        v6.display(-1, ("Your biggest flex this year? Dropping \238\128\130%* Robux on @%* back on %*. Absolutely iconic."):format(v23.donatedRobux, v23.boothOwnerUsername, (v23.whenDonated:FormatLocalTime("LL", "en-us"))), "none");
    end;
    local v26 = nil;
    for _, v28 in v19.donations do
        if v28.boothOwnerUserId == userid and (v26 == nil or v28.donatedRobux > v26.donatedRobux) then
            v26 = v28;
        end;
    end;
    if v26 then
        v6.display(-1, ("Biggest bag secured this year? \238\128\130%* Robux from @%* on %*. What a moment."):format(v26.donatedRobux, v26.donatorUsername, (v26.whenDonated:FormatLocalTime("LL", "en-us"))), "none");
    end;
    local v29 = {};
    for _, v31 in v19.donations do
    ...
    if v33 then
        v6.display(0, ("The most Robux you donated in a single day was \238\128\130%* on %*. That's impressive..."):format(v29[v33], v33), "none");
    end;
    local v35 = {};
    for _, v37 in v19.donations do
    ...
    if v39 then
        v6.display(0, ("The most Robux you raised in a single day was \238\128\130%* on %*. A milestone worth celebrating."):format(v35[v39], v39), "none");
    end;
    local v41 = (v19.thisyeardonated or 0) / (v19.lastyeardonated or 0);
    if v41 > 1 then
        v6.display(1, ("You donated %*%% more Robux than last year (\238\128\130%* -> \238\128\130%*). Impressive growth."):format(math.floor(v41 * 100 - 100), v19.lastyeardonated, v19.thisyeardonated), "none");
    elseif v41 < 1 then
        v6.display(1, ("Bruh... You donated %*%% less Robux than last year (\238\128\130%* -> \238\128\130%*). Respectfully, step up your game."):format(math.floor(100 - v41 * 100), v19.lastyeardonated, v19.thisyeardonated), "none");
    else
    ...
    if v42 > 1 then
        v6.display(1, ("You raised %*%% more Robux than last year (\238\128\130%* -> \238\128\130%*). Awesome!"):format(math.floor(v42 * 100 - 100), v19.lastyearraised, v19.thisyearraised), "none");
    elseif v42 < 1 then
        v6.display(1, ("You raised %*%% less Robux than last year (\238\128\130%* -> \238\128\130%*)... \240\159\146\128"):format(math.floor(100 - v42 * 100), v19.lastyearraised, v19.thisyearraised), "none");
    else
    ...
    v6.display(11, ("You donated to <b>%*</b> unique players this year. Sharing the love far and wide."):format(v47), "people");
    local v49 = 0;
    for _ in pairs(v44) do
        v49 = v49 + 1;
    end;
    v6.display(11, ("You received donations from <b>%*</b> unique players this year. The support is real."):format(v49), "people");
    local v51 = {};
    local v52 = {};
	for _, v54 in v19.donations do
		print(v54)
    ...
    if #v51 > 0 then
        ...
        v6.display(2, ("Your most popular gamepass is %* with <b>%*</b> sales. A true crowd favorite."):format(getProductInfo(v51[1].gamepassId).Name, v51[1].sales), "none");
    end;
    if #v51 > 0 then
        ...
        script.Parent:FindFirstChild("2").IconFrame.Icon.Image = "rbxassetid://" .. getProductInfo(v51[1].gamepassId).IconImageAssetId;
        v6.display(2, ("Your top earner gamepass is %* with \238\128\130%* Robux in total earnings. Outstanding performance."):format(getProductInfo(v51[1].gamepassId).Name, v51[1].earnings), "none");
    end;
    local v60 = {};
    local v61 = {};
    for _, v63 in v19.donations do
    ...
    if #v60 > 0 then
        ...
        v6.display(3, ("Your most dedicated donor is @%* with <b>%*</b> donations. Truly generous."):format(getPlayerData(v60[1].userId).Username, v60[1].donations), "none");
    end;
    if #v60 > 0 then
        ...
        script.Parent:FindFirstChild("3").IconFrame.Icon.Image = "https://www.roblox.com/headshot-thumbnail/image?userId=" .. v60[1].userId .. "&width=420&height=420&format=png";
        v6.display(3, ("The donor who gave the most Robux is @%* with \238\128\130%* Robux. Incredible support."):format(getPlayerData(v60[1].userId).Username, v60[1].donated), "none");
    end;
    ...
    v6.display(4, ("Based on your Ratio this year, your title is . . . %*. %*"):format(v74, v75), "bold");
    l_RewindButton_0.Visible = true;
