...
if v5 then
    print((("The largest donation you made is %* to @%* on %*"):format(v5.donatedRobux, v5.boothOwnerUsername, (v5.whenDonated:FormatLocalTime("LL", "en-us")))));
end;
local v8 = nil;
for _, v10 in v3.donations do
    if v10.boothOwnerUserId == l_userid_0 and (v8 == nil or v10.donatedRobux > v8.donatedRobux) then
        v8 = v10;
    end;
end;
if v8 then
    print((("The largest donation you received is %* from %* on %*"):format(v8.donatedRobux, v8.donatorUsername, (v8.whenDonated:FormatLocalTime("LL", "en-us")))));
end;
local v11 = {};
local v12 = {};
for _, v14 in v3.donations do
...
if v16 then
    print((("The most Robux you donated in a day was %* on %*"):format(v11[v16], v16)));
end;
local v18 = nil;
for v19 in v12 do
...
if v18 then
    print((("The most Robux you raised in a day was %* on %*"):format(v12[v18], v18)));
end;
local v20 = v3.thisyeardonated / v3.lastyeardonated;
if v20 > 1 then
    print((("You donated %*%% more robux than last year (%* -> %*)"):format(math.floor(v20 * 100 - 100), v3.lastyeardonated, v3.thisyeardonated)));
elseif v20 < 1 then
    print((("You donated %*%% less robux than last year (%* -> %*)"):format(math.floor(100 - v20 * 100), v3.lastyeardonated, v3.thisyeardonated)));
else
    print("You donated the same amount of robux as last year!");
end;
local v21 = v3.thisyearraised / v3.lastyearraised;
if v21 > 1 then
    print((("You raised %*%% more robux than last year (%* -> %*)"):format(math.floor(v21 * 100 - 100), v3.lastyearraised, v3.thisyearraised)));
elseif v21 < 1 then
    print((("You raised %*%% less robux than last year (%* -> %*)"):format(math.floor(100 - v21 * 100), v3.lastyearraised, v3.thisyearraised)));
else
    print("You raised the same amount of robux as last year!");
end;
local v22 = {};
local v23 = {};
for _, v25 in v3.donations do
...
print((("You donated to %* unique players this year!"):format(v26)));
local v28 = 0;
for _ in v23 do
    v28 = v28 + 1;
end;
print((("You received donations from %* unique players this year!"):format(v28)));
local v30 = {};
local v31 = {};
for _, v33 in v3.donations do
...
if #v30 > 0 then
    print((("The gamepass with most sales is %* with %* sales"):format(v30[1].gamepassId, v30[1].sales)));
end;
table.sort(v30, function(v37, v38) --[[ Line: 145 ]]
    return v37.earnings > v38.earnings;
end);
if #v30 > 0 then
    print((("The gamepass with most earnings is %* with %* robux"):format(v30[1].gamepassId, v30[1].earnings)));
end;
local v39 = {};
local v40 = {};
for _, v42 in v3.donations do
...
if #v39 > 0 then
    print((("You received the most donations from %* with %* donations"):format(v39[1].userId, v39[1].donations)));
end;
table.sort(v39, function(v46, v47) --[[ Line: 178 ]]
    return v46.donated > v47.donated;
end);
if #v39 > 0 then
    print((("You raised the most robux from %* with %* robux"):format(v39[1].userId, v39[1].donated)));
end;