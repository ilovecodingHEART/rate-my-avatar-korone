    ...
    if l_FirstChild_0:IsA("Frame") then
        ...
        if v43 then
            if v43.giftType == "UGC" then
                ...
                l_FirstChild_0.Gift.GiftButton.Image = ("https://www.roblox.com/asset-thumbnail/image?assetId=%*&width=420&height=420&format=png"):format(v43.giftId);
...
v8.OnClientEvent("OpenCalendarGift"):Connect(function(_, v150, v151) --[[ Line: 365 ]]
    ...
    for _, v169 in l_Parent_1.Frame:GetChildren() do
        if v169:IsA("Frame") then
            ...
            if v170 == "Released" then
                ...
                v169.Countdown.Day.Text = ("Day %*"):format(v169.LayoutOrder);
