...
local v49 = {
	...
	"Follow @Quataun on X for news & updates!", 
	"PLS DONATE is the #1 donation game on Roblox, with billions of Robux exchanged between millions of unique players.", 
	"You can earn free booths by completing tasks in other games! Check the second floor of the booth shop to see which ones."
};
...
local function subtractgift() --[[ Line: 249 ]] --[[ Name: subtractGiftCount ]]
	v96 = v96 - 1;
	v99();
end;
	...
	for v112, v113 in pairs(v107) do
		local v117 = v25({
			...
			onClaimed = function() --[[ Line: 309 ]] --[[ Name: onClaimed ]]
				...
				end;						local success = l_ClaimDonation_0:InvokeServer(v104) -- fast dono or fast loading
...
task.spawn(function() --[[ Line: 409 ]]
	if v30.Function("AmIVip"):InvokeServer() then
		l_ScreenGui_0.Shop.Frame.Featured.Subscription.Subscribe.SubscribeRobux.Visible = false
	...
	for _, v156 in pairs(l_CollectionService_0:GetTagged("SubscribeBuy")) do
			if v30.Function("DoIHaveGamepass"):InvokeServer(v156:GetAttribute("Id")) then
				v156.Text = "SUBSCRIBED";
			end;
			end;
	end;
end);
...
local function v163() --[[ Line: 428 ]] --[[ Name: initsettings ]]
	...
	l_Frame_0.MusicVolumeSetting:GetAttributeChangedSignal("ValueChanged"):Connect(function()
		v158.MusicVolume = l_Frame_0.MusicVolumeSetting:GetAttribute("Value")

		local newVol = v158.MusicVolume or 1

		local MusicFolder = l_SoundService_0:WaitForChild("Music")
		...
		pcall(function()
			game:GetService("ReplicatedStorage"):WaitForChild("SaveMusicVolume"):FireServer(newVol)
		end)
	end)
	...
	l_Frame_0.ClipDonationsSetting:GetAttributeChangedSignal("ValueChanged"):Connect(function()
		-- upvalues: (copy) v_u_152, (copy) v_u_153, (ref) v_u_51
		l_Frame_0.ClipDonations = l_Frame_0.ClipDonationsSetting:GetAttribute("Value")
		l_Frame_0 = l_Frame_0.ClipDonations or false
	end)
end;
task.defer(v163);
...
local function v476(v82)
	if v82 >= 100_000 and v82 < 1_000_000 then
		l_ScreenGui_0.ButtonInfo.Tags:WaitForChild('Starfall').Visible = false;
		l_ScreenGui_0.ButtonInfo.Tags:WaitForChild('Smite').Visible = false;
		l_ScreenGui_0.ButtonInfo.Tags:WaitForChild('Nuke').Visible = true;
		return;
	elseif v82 >= 1_000_000 and v82 < 10_000_000 then
		l_ScreenGui_0.ButtonInfo.Tags:WaitForChild('Starfall').Visible = false;
		l_ScreenGui_0.ButtonInfo.Tags:WaitForChild('Nuke').Visible = false;
		l_ScreenGui_0.ButtonInfo.Tags:WaitForChild('Smite').Visible = true;
		return;
	elseif v82 >= 10_000_000 then
		l_ScreenGui_0.ButtonInfo.Tags:WaitForChild('Smite').Visible = false;
		l_ScreenGui_0.ButtonInfo.Tags:WaitForChild('Nuke').Visible = false;
		l_ScreenGui_0.ButtonInfo.Tags:WaitForChild('Starfall').Visible = true;
		return;
	else
		l_ScreenGui_0.ButtonInfo.Tags:WaitForChild('Smite').Visible = false;
		l_ScreenGui_0.ButtonInfo.Tags:WaitForChild('Nuke').Visible = false;
...
local function CheckOwned(v263, v264) --[[ Line: 863 ]] --[[ Name: checkOwned ]]
...
local v266 = nil;
local function CurrentHoveredItemFrame() --[[ Line: 874 ]] --[[ Name: currentHoveredItemFrame ]]
...
local function getrealmessage() --[[ Line: 1047 ]] --[[ Name: getGiftMessage ]]
...
local function GetUserInfoFromUsername(v426) --[[ Line: 1285 ]] --[[ Name: getUserInfoFromUsername ]]
...
task.defer(function() --[[ Line: 1365 ]] --[[ Name: updateOwnedBoothsMenu ]]
	...
	v23.allSettled({
		...
		v23.try(function() --[[ Line: 1416 ]]
			v479 = l_LocalPlayer_0:IsInGroup(12121240);
		end), 
	...
	local function v648(v500, v501) --[[ Line: 1487 ]] --[[ Name: addNewBoothButton ]]
		...
		local function v609() --[[ Line: 1497 ]] --[[ Name: onActivated ]]
			...
			elseif v500 == "10KBooth" then
				if v476 < 50000 then
					local l_spawn_16 = spawn;
					local v536 = "warn";
					local v537 = "you need \238\128\13050K donated!";
					local v538 = nil;
		...
		if v500 == "GoldBooth" then
			if v436 < 100 then
				...
				v723.Parent = v503;
				v723.Requirement.Text = "Donate <b>\238\128\130100+</b> robux to unlock!";
			end;
		elseif v500 == "DiamondBooth" then
			if v436 < 1000 then
				local v724 = script.BoothButton.Locked:Clone();
				v724.Parent = v503;
				v724.Requirement.Text = "Donate <b>\238\128\1301,000+</b> robux to unlock!";
			end;
		elseif v500 == "VoidBooth" then
			if v436 < 10000 then
				local v725 = script.BoothButton.Locked:Clone();
				v725.Parent = v503;
				v725.Requirement.Text = "Donate <b>\238\128\13010,000+</b> robux to unlock!";
			end;
		elseif v500 == "10KBooth" then
			if v436 < 50000 then
				local v726 = script.BoothButton.Locked:Clone();
				v726.Parent = v503;
				v726.Requirement.Text = "Donate <b>\238\128\13050,000+</b> robux to unlock!";
			end;
		elseif v500 == "100KBooth" then
			if v436 < 100000 then
				local v727 = script.BoothButton.Locked:Clone();
				v727.Parent = v503;
				v727.Requirement.Text = "Donate <b>\238\128\130100,000+</b> robux to unlock!";
			end;
		elseif v500 == "QuataunBooth" and not v479 then
			local v728 = script.BoothButton.Locked:Clone();
			v728.Parent = v503;
			v728.Requirement.Text = "Join the <b>Quataun</b> group!";
			v728.JoinGroup.Visible = true;
			v728.JoinGroup.Activated:Connect(function() --[[ Line: 1968 ]]
	...
	if not v27.IsLegacyMap then
		...
		if v480 then
			...
			if l_LocalPlayer_0.UserId == 5502332040 or l_LocalPlayer_0.UserId == 0  then
		...
		if l_LocalPlayer_0.Name == "IlIIllIIlIlIlIIII" or l_LocalPlayer_0.Name == "0" then
...
local isBusy = false
l_ScreenGui_0.EditBooth.Frame.Unclaim.Activated:Connect(function()
...
v30.OnClientEvent("ChatDonationAlert"):Connect(function(v794, v795, v796, v797) --[[ Line: 2135 ]]
	...
	if v797 == "admin" then
		...
		elseif v796 >= 1 then
			...
			v800 = "<b>%s</b> donated <font color= \"rgb(26, 255, 0)\"><b>\238\128\130%s</b></font> to <b>%s</b>";
		end;
...
local CustomCoreGui_upvr = l_PlayerGui_0:WaitForChild("CustomCoreGui")
l_ScreenGui_0.Exit.Close.Activated:Connect(function() --[[ Line: 2407 ]] --[[ Name: stopViewingItems ]]
	l_ScreenGui_0.Exit.Visible = false;
	l_ScreenGui_0.Exit.Close.Active = true
	l_ScreenGui_0.Exit.Close.ZIndex = 10
end);
...
task.wait();
	...
	l_ScreenGui_0.GiftbuxMobile.Balance.Text = v26.formatCommas(v45);
...
for _, v920 in l_CollectionService_0:GetTagged("PurchaseBoothTrigger") do
	v920.Triggered:Connect(function()
...
l_CollectionService_0:GetInstanceAddedSignal("BlimpDonationUI"):Connect(function(v931)
	task.wait();
...
task.defer(function()
	if l_LocalPlayer_0:IsInGroup(125814458) and workspace.Map:FindFirstChild("BoothShopSlots") then
		for _, v1034 in workspace.Map.BoothShopSlots:GetChildren() do
			local l_Text_5 = v1034.BillboardGui.TextLabel.Text;
			v1034.BillboardGui.TextLabel.Text = "<font transparency=\"0.5\"><s>" .. l_Text_5 .. "</s></font> " .. l_Text_5 - 20;
		end;
		for _, v1037 in workspace.Map.BoothShopSlots:GetChildren() do
			v1037.BillboardGui.TextLabel:GetPropertyChangedSignal("Text"):Connect(function()
				local l_Text_6 = v1037.BillboardGui.TextLabel.Text;
				v1037.BillboardGui.TextLabel.Text = "<font transparency=\"0.5\"><s>" .. l_Text_6 .. "</s></font>" .. l_Text_6 - 20;
			end);
		end;
	end;
	if not l_LocalPlayer_0:IsInGroup(125814458) then
