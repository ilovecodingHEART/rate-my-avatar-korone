...
v0.create = function(v10, v11, v12, v13, v14) --[[ Line: 27 ]] --[[ Name: create ]]
    -- upvalues: l_Frame_0 (copy), v2 (copy), l_TweenService_0 (copy)
    v14 = v14 or false;
    v11 = v11 or l_Frame_0;
    spawn(function() --[[ Line: 31 ]]
        -- upvalues: v13 (copy), v12 (copy), v11 (ref), v10 (copy), v14 (ref), v2 (ref), l_TweenService_0 (ref)
        for _ = 1, v13 do
            for _ = 1, v12 do
                local v17 = v11:Clone();
                v17.Parent = v10;
                ...
                v20.Completed:Connect(function() --[[ Line: 48 ]]
                    -- upvalues: v17 (copy), l_TweenService_0 (ref)
                    local l_v17_0 = v17;
                    local v22 = {
